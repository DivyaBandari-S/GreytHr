...
class Kudos1 extends Component
{
    ...
    if ($employeeId === auth()->user()->emp_id) {
        ...
        if (is_array($reactions)) {
            ...
            foreach ($reactions as $index => $reaction) {
                if ($reaction['employee_id'] === $employeeId && 
...
public $reactionEmojis = [
    ...
    ->get();
                ...
                //     $this->kudos = Kudos1::where(function ($query) use ($employeeId) {
    ...
    public function handleRadioChange($value)
{
    ...
    public function render()
    {
        ...
        return view('livewire.kudos1',[     'empCompanyLogoUrl' => $this->empCompanyLogoUrl,     ]);
    }
}
