...
.clickable-date1{
background-color: pink; /* Set the desired background color when clicked */
                        ...
                        <div class="modal-body">
                            <div class="form-row" style="display: flex; justify-content: flex-end;">
                                <div class="form-group col-md-3 col-sm-6">
                                    <label for="fromDate"
                                        style="color: #778899; font-size: 12px; font-weight: 500;">From
                                        date</label>
                                    <input type="date" class="form-control" id="fromDate" wire:model="from_date" name="fromDate" wire:change="calculateTotalDays"
                                        style="color: #778899;">
                                </div>
                                <div class="form-group col-md-3 col-sm-6">
                                    <label for="toDate" style="color: #778899; font-size: 12px; font-weight: 500;">To
                                        date</label>
                                    <input type="date" class="form-control" id="toDate" name="toDate"  wire:model="to_date" wire:change="calculateTotalDays"
                                        style="color: #778899;">
                                </div>
                            </div>
                            <p style="font-size:12px;">Total Working Days:&nbsp;&nbsp;<span
                                    style="font-weight:bold;">{{$totalDays}}</span></p>
                    ...
                    <table class="table-1 table-bordered">
                        ...
                        <tbody id="calendar-body">
                            ...
                            <tr>
                                ...
                                @if ($day)
                                @if(strtotime($formattedDate) < strtotime(date('Y-m-d'))) @php $flag=1; @endphp @else @php $flag=0; @endphp @endif @if($day['status']=='CLP' ||$day['status']=='SL' ||$day['status']=='LOP' ) @php $leave=1; @endphp @else @php $leave=0; @endphp @endif
