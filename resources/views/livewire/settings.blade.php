                ...
                @if ($showDialog)
                    <div class="modal" tabindex="-1" role="dialog" style="display: block;">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: rgb(2, 17, 79);">
                                    <h5 style="padding: 5px; color: white; font-size: 14px;" class="modal-title">
                ...
                <div class="row m-0">
                    <div class="col-md-2">
                        @if (!empty($employee->image))
                            <img style="border-radius: 50%; padding: 8px;" height="80" width="80"
                                src="{{ asset('storage/' . $employee->image) }}" alt="">
                        @else
                            <!-- Default user image -->
                            <img style="border-radius: 50%; padding: 8px;" height="80" width="80"
                    ...
                    <div class="col-md-5">
                        <div class="mb-2" style="font-size:13px;">
                            <strong>{{ ucwords(strtolower($employee->first_name)) }}
                                {{ ucwords(strtolower($employee->last_name)) }}</strong></div>
