                    ...
                    <div>
                        <button
                            style="width:200px; border-radius: 5px; background-color: rgb(2, 17, 79); color: white;"><a
                                href="/update-employee-details" style="text-decoration: none;color:white;font-size:14px;">Employee
                                List</a></button>
                    </div>
                </div>
...
<div class="col-md-2"></div>
                        ...
                        <div class="bg-light m-0 row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="file"  wire:model="image"
                                    style="margin-bottom:10px;font-size:12px;border:none;">
                                @error('image')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <img src="{{ is_string($image) ? asset('storage/' . $image) : $image->temporaryUrl() }}"
                                alt="Preview" width="25" height="25" class="img-thumbnail" />
                    ...
                    <fieldset>
                        ...
                        <hr class="hr-wizard" />
                        @if($employeeId)
                        <button wire:click="updateEmployee" class="btn btn-primary"
                            wire:loading.attr="disabled" style="float: inline-end">Update</button>
                        @else
                        ...
                        @endif
                        <!-- <input type="button" name="next" class="next ilynn-btn" value="Next" onclick="getChecked()" /> -->
                        <input type="button" name="previous" class="previous ilynn-btn" value="Back" />
                    </fieldset>
                </form>
