                ...
                <div class="panel">
                    ...
                    <div class="row m-0 mb-3">
                        ...
                        <div class="col-md-3 mb-2 pe-0" style="display: flex">
                            ...
                            <p class="m-0 legend-text">Half Day</p>
                        </div>
                        <div class="col-md-3 mb-2 pe-0" style="display: flex">
                            <p class="mb-0">
                                <i class="fas fa-battery-empty" style="color: #778899;"></i>
                            </p>
                            <p class="m-0 legend-text">Plant Shutdown</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <thead>
                        <tr>
                            <th
                                ...
                                Employee Name</th>
                            <th
                                style="width:25%;background:#ebf5ff;color:#778899;font-weight:500;line-height:2;font-size:0.8255rem;">
                                P</th>
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                {{ ucwords(strtolower($emp->first_name)) }}&nbsp;{{ ucwords(strtolower($emp->last_name)) }}<span
                                    class="text-muted">(#{{ $emp->emp_id }})</span><br /><span class="text-muted"
                                    style="font-size:11px;">{{ucfirst($emp->job_title)}},{{ucfirst($emp->city)}}</span>
                            </td>
                            @php
                            $found = false;
                            @endphp
