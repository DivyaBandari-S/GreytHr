    ...
    <body>
        <div>
            ...
            <div class="revisionnorecords">
                <img class="revisionnorecordsimage" src="https://static.vecteezy.com/system/resources/thumbnails/007/872/974/small/file-not-found-illustration-with-confused-people-holding-big-magnifier-search-no-result-data-not-found-concept-can-be-used-for-website-landing-page-animation-etc-vector.jpg" alt="">
                <p>No data found</p>
            </div>
            @else
                ...
                <table class="salaryRevisionStable  table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>0.00</td>
                            @else
                            <td>{{ number_format(($revisionData['revised_ctc'] / 12) - ($revisionData['current_ctc'] / 12), 2) }}</td>
                            @endif
