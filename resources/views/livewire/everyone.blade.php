                ...
                <div class="col-md-3 feeds-custom-menu bg-white p-3 mb-2">
                    ...
                    <div class="posts">
                        <label class="custom-radio-label">
                            ...
                            <input type="radio" id="radio-hr" name="radio" value="posts" checked data-url="/everyone" wire:click="handleRadioChange('posts')">
                    ...
                    <div class="col-md-12 col-md-8">
                        <div class="eventsSection">
                            ...
                            <div id="post-container " class="feeds-main-content">
                                ...
                                <div class="col-12 col-md-9 mt-2" id="post-{{ $post->id }}">
                                    <div class="post-card">
                                        <div class="row">
