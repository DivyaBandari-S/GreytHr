    ...
    <div class="modal-body" style="max-height:300px;overflow-y:auto">
        ...
        <table class="swipes-table mt-2 border" style="width: 100%;">
            ...
            <tr style="border:1px solid #ccc;">
                <td style="width:50%;font-size: 10px; color: #778899;text-align:start;padding:5px 10px;white-space:nowrap;">{{ucwords(strtolower($emp->first_name))}}&nbsp;{{ucwords(strtolower($emp->last_name))}}</td>
