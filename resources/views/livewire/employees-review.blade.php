        ...
        <div class="sidenav col-md-3 col-lg-2" style="min-height: 30rem;">
            <div>
                <ul class="nav flex-column side-page-nav">
                    <div class="emp-side-page-nav-item-group">ATTENDANCE</div>
                    ...
                    <div class="emp-side-page-nav-item-group">LEAVE</div>
                    <li class="nav-item emp-side-page-nav-item" tabindex="0">
                        <p class="emp-leave-count">
                            <span class="nav-link emp-info {{ $activeTab === 'leave' ? 'active' : '' }}"
                                wire:click="setActiveTab('leave')">
                                Leave
                            </span>
                            <span class="count-pending -leaves text-center my-0 mx-1 font-weight-500"
                                style=" background: #FAE392; border-radius:50%;font-size:8px;color: #2f363d;padding:5px 5px;width: 16px;
    height: 25px;">
                                {{$count}}
                            </span>
                        </p>
        ...
        <div class="col-md-9 col-lg-9 py-2x ml-3x">
            ...
            <div class="row mt-3" style="display:flex; justify-content: end;">
                ...
                <div class="col-3 emp-input-with-icon">
                    <input autocomplete="off" placeholder="Search Employee" name="searchKey" typeaheadoptionfield="name"
                        typeaheadwaitms="300" class="form-control text-overflow ng-untouched ng-pristine ng-valid"
                        aria-exp anded="false" aria-autocomplete="list">
                    <i class="fa-solid fa-magnifying-glass"></i>
                </div>
