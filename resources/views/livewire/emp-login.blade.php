        ...
        @if (session()->has('empIdMessageType'))
            <div class="alert alert-{{ session('empIdMessageType') }} mt-3 position-relative">
                <button type="button" class="btn-close position-absolute" style="top: 10px; right: 10px;"
                    aria-label="Close" wire:click="$set('empIdMessageType', null); $set('empIdMessage', null)"></button>
                ...
                <form wire:submit.prevent="empLogin" wire:key="empLogin-{{ $resetKey }}"
                    ...
                    <div class="form-group" style="margin-top: 20px;">
                        ...
                        <div class="input-group">
                            ...
                            @if ($showEyeIcon)
                                <span style="background-color: #fff" class="input-group-text pointer"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="background-color: #f0f0f0;">
                                <p style="padding: 30px 0px; text-align: center;">Do you want to Reset your password?
                                </p>
