<div>
            ...
            <section id="catalogCardView" class="showIt">
                ...
                <div class="col-md-4 mb-4">
                        <div style="background:white; border:1px solid #d3d3d3; border-radius:5px; padding: 10px 15px;">
                            ...
                            <div class="row m-0">
                                <div class="col-12 text-center mb-2" style="font-size:12px">
                                    <img src="images/it-images/mail.png" style="height:5em;" />
                                </div>
    ...
    @enderror
                ...
                <div class="row m-0">
                    ...
                    <div class="col-md-4 mb-4">
                        <div style="background:white; border:1px solid #d3d3d3; border-radius:5px; padding: 10px 15px;">
                            ...
                            <div class="row m-0">
                                <div class="col-12 text-center mb-2" style="font-size:12px">
                                    <img src="images/it-images/laptop.png" style="height:5em;" />
                                </div>
                                <div class="col-12 mb-2" style="font-size:12px">
                ...
                <div id="requestCard" class="row m-0 p-0 ">
                        ...
                        <div class="col-md-4 mb-4">
                            <div
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-12 mb-2" style="font-size:12px">
                                        <p
                                            style="text-decoration:underline;cursor: pointer; text-align: center;" wire:click="O365Desktop">
                                            O365 Desktop License Access</p>
                                    </div>
                                    @if($O365DesktopRequestaceessDialog)
                                <div class="modal" tabindex="-1" role="dialog" style="{{ $showModal ? 'display: block;' : 'display: none;' }}">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">O365 Desktop License Access</h1>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row m-0">
                                                    <div class="col-4 m-auto">
                                                    ...
                                                    <div class="col-8 m-auto">
                                                        <p style="font-size:15px;">Use this Catalogue item to submit a request for O365 Desktop Access</p>
                                                    </div>
                                                </div>
                                                <hr style="border: 1px solid #ccc; margin: 10px 0;">
                        ...
                        <div class="col-md-4 mb-4">
                            <div
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-12 mb-2">
                                        <p
                                            style="text-decoration:underline;cursor: pointer; text-align: center;font-size: 12px;" wire:click="newSim">
                                            New SIM Request</p>
                                    </div>
                                    @if($NewSimRequestaceessDialog)
                                <div class="modal" tabindex="-1" role="dialog" style="{{ $showModal ? 'display: block;' : 'display: none;' }}">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">SIM Request</h1>
                                            ...
                                            <div class="modal-body">
                                                <div class="row m-0">
                                                    ...
                                                    <div class="col-8 m-auto">
                                                        <p style="font-size:15px;">New SIM Request</p>
                                                    </div>
                                                </div>
                                                <hr style="border: 1px solid #ccc;margin: 10px 0;">
                                                <form wire:submit.prevent="Devops">
                        ...
                        <div class="col-md-4 mb-4">
                            <div
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-12 mb-2" style="font-size:12px">
                                        <p
                                            style="text-decoration:underline;cursor: pointer; text-align: center;" wire:click="PrivilegeRequest">
                                            Privilege Access Request</p>
                                    </div>
                                    @if($PrivilegeRequestaceessDialog)
                                <div class="modal" tabindex="-1" role="dialog" style="{{ $showModal ? 'display: block;' : 'display: none;' }}">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Privilege Access Request</h1>
                                            ...
                                            <div class="modal-body">
                                                <div class="row m-0">
                                                    ...
                                                    <div class="col-8 m-auto">
                                                        <p style="font-size:15px;"> Privilege Access Request</p>
                                                    </div>
                                                </div>
                                                <hr style="border: 1px solid #ccc;margin: 10px 0;">
                                                <form wire:submit.prevent="Devops">
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-12 mb-2 p-0 ">
                                        <div style="max-width: 100%; overflow: hidden;">
                                            <p
                                                style="text-decoration:underline; cursor: pointer;font-size:12px " wire:click="RemoveDistributor">
                                                Remove Members from Distribution List</p>
                                        </div>
                                        @if($RemoveRequestaceessDialog)
                                <div class="modal" tabindex="-1" role="dialog" style="{{ $showModal ? 'display: block;' : 'display: none;' }}">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Remove Members from Distribution List</h1>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row m-0">
                                                    <div class="col-4 m-auto">
                                                    ...
                                                    <div class="col-8 m-auto">
                                                        <p style="font-size:15px;">Use this Catalogue Item to raise a Request for Removing Members from Distribution List
                        ...
                        <div class="col-md-4 mb-4">
                            <div
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-12 mb-2">
                                        <p
                                            style="text-decoration:underline;cursor: pointer; text-align: center;font-size:12px" wire:click="RemoveMail">
                                            Remove Members from Mailbox</p>
                                    </div>
                                    @if($RemoveMailRequestaceessDialog)
                                <div class="modal" tabindex="-1" role="dialog" style="{{ $showModal ? 'display: block;' : 'display: none;' }}">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Remove Members from Mailbox</h1>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row m-0">
                                                    <div class="col-4 m-auto">
                                                    ...
                                                    <div class="col-8 m-auto">
                                                        <p style="font-size:15px;">Use this Catalogue item to Remove Members from Mailbox</p>
                                                    </div>
                                                </div>
                                                <hr style="border: 1px solid #ccc; margin: 10px 0;">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <hr style="border: 1px solid #ccc;margin: 10px 0;">
                                                <form wire:submit.prevent="Internet">
...
<div class="form-group col-md-6 mt-2 ml-3" style="margin-left:10px">
    ...
    @error('mail') <span class="text-danger">{{ $message }}</span> @enderror
                                                    ...
                                                    <div class="form-group mt-2">
                                                        <label for="reason">Describe Issue<span style="color:red">*</span></label>
                                                        <textarea wire:model.lazy="description" wire:keydown.debounce.500ms="validateField('description')" class="form-control"></textarea>
                                                        @error('description') <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                    ...
                    <div class="row m-0 p-0">
                        ...
                        <div class="col-md-4 mb-4">
                            <div
                                style="background:white; border:1px solid #d3d3d3; border-radius:5px; padding: 10px 15px;">
                                <p style="font-size: 12px;"><b>Share Point Request</b></p>
                                <div class="row m-0">
                                    <div class="col-12 text-center mb-2">
                                        <!-- <img src="https://snow.payg.in/a9fa00e9871c7510279786a50cbb3525.iix?t=medium"
                                                    style="height:4em;"> -->
                                    ...
                                    <div class="col-12 mb-2" style="font-size:12px">
                                        <p
                                        id="showBtnDiv" style="text-decoration:underline;cursor: pointer; text-align: center;" wire:click="SharePointRequest">
                                        Share Point Request</p>
                                    </div>
                                    @if($ShareRequestaceessDialog)
                                <div class="modal" tabindex="-1" role="dialog" style="{{ $showModal ? 'display: block;' : 'display: none;' }}">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel"> Share Point Request</h1>
...
<script>
    ...
    function showMoreItems() {
        // Ensure only visibility-related classes are toggled for showMoreItems
        $('#requestCard').removeClass('hideIt').addClass('showIt'); // Ensure it's visible
        $('#removeCard').removeClass('hideIt').addClass('showIt'); // Ensure it's visible
        $('#showBtnDiv').addClass('hideIt').removeClass('showIt'); // Hide the button
    }

    // Handle Livewire events
    document.addEventListener('livewire:load', function() {
        Livewire.on('showModal', function() {
            // Ensure modal visibility logic does not affect the requestCard
            $('#modal').modal('show'); // Show the modal
        });

        Livewire.on('closeModal', function() {
            $('#yourModal').modal('hide'); // Hide the modal
        });
    });

    // Modal trigger handler to ensure `#requestCard` remains visible
    document.addEventListener('click', function(event) {
        if (event.target.matches('[wire:click]')) {
            // Ensure #requestCard stays visible when the modal is triggered
            $('#requestCard').removeClass('hideIt').addClass('showIt');
        }
    });
