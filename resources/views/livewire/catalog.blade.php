<div>
    <div wire:loading
        wire:target="file_path,AddRequest,DistributorRequest,ItRequest,submit,MailRequest,Request,IdRequest,Devops,MmsRequest,DistributionRequest,DistributorRequest,LapRequest,DevopsRequest,closecatalog,redirectToHelpDesk,NamesSearch,ServiceRequest">
 ...
 <div class="form-group mt-2">
            ...
            <!-- Email -->
            <div class="form-group col-md-5 mt-2" style="margin-left:10px">
                <label for="mail">Email <span style="color:red">*</span></label>
                <input type="text" id="mail" class="form-control"   wire:model="mail"  >
            </div>
        </div>
                                                    <div class="form-group mt-2">
                                                        <label for="priority" class="helpdesk-label">Priority<span style="color:red">*</span></label>
