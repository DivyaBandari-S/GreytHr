    ...
    <div class="col-md-3" style="background-color: white; border: 1px solid #D9D9D9; border-radius: 5px; display: flex; align-items: center; flex: 1; box-sizing: border-box; height: 60px;">
        ...
        <a class="links" href="/documents" style="margin-left: auto; padding-right: 10px; font-size: 12px; color: black; text-decoration: none;">
            ...
            <div class="row" style="margin-top: 20px; display: flex; flex-wrap: wrap; gap: 10px;">
                ...
                <div class="col-md-3" style="background-color: white; border: 1px solid #D9D9D9; border-radius: 5px; display: flex; align-items: center; flex: 1; box-sizing: border-box; height: 60px;">
        <img src="https://th.bing.com/th/id/OIP.lOQHjvDS8UGgyzbJ6N-WqAAAAA?pid=ImgDet&rs=1" alt="Image Description" style="height: 30px; width: 30px; margin-left: 10px; margin-right: 5px;">
