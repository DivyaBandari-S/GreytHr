...
</span><span class="custom-radio-button bg-blue"style="margin-left:10px;font-size:10px"></span>Posts</label></div>
...
<div class="w-full visible mt-1" style="margin-top: 20px;">
    ...
    {{ ucwords(strtolower($data['employee']->last_name)) }},
                            ...
                            <div style="display: flex; align-items: center;">
                                ...
                                <p style="margin-left: 10px; font-size: 12px; color: black;margin-bottom:0;s">
                                    Happy Birthday {{ ucwords(strtolower($data['employee']->first_name)) }}
    {{ ucwords(strtolower($data['employee']->last_name)) }}! 🎂
                                </p>
                            </div>
...
<div class="row" style="display: flex;">
    ...
    <span id="smiley-{{ $index }}" class="emoji-trigger" onclick="showEmojiList({{ $index }})" style="font-size: 16px;">
        😊 
    ...
    <div class="emoji-row">
    <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128512','{{ $data['employee']->emp_id }}')">😀</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128513','{{ $data['employee']->emp_id }}')">😁</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128514','{{ $data['employee']->emp_id }}')">😂</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128515','{{ $data['employee']->emp_id }}')">😃</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128516','{{ $data['employee']->emp_id }}')">😄</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128517','{{ $data['employee']->emp_id }}')">😅</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128518','{{ $data['employee']->emp_id }}')">😆</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128519','{{ $data['employee']->emp_id }}')">😇</span>
...
<div class="emoji-row">
<span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128528','{{ $data['employee']->emp_id }}')">😐</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128529','{{ $data['employee']->emp_id }}')">😑	</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128530','{{ $data['employee']->emp_id }}')">😒</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128531','{{ $data['employee']->emp_id }}')">😓</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128532','{{ $data['employee']->emp_id }}')">😔</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128533','{{ $data['employee']->emp_id }}')">😕</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128534','{{ $data['employee']->emp_id }}')">😖</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128535','{{ $data['employee']->emp_id }}')">😗</span>
...
<div class="emoji-row">
    ...
    <div  class="emoji-row">
    <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128072','{{ $data['employee']->emp_id }}')">👈</span>
    <span class="emoji-option" style="font-size: 14px;" wire:click="addEmoji('&#128073','{{ $data['employee']->emp_id }}')">👉</span>
    <span class="emoji-option" style="font-size: 14px;" wire:click="addEmoji('&#128405','{{ $data['employee']->emp_id }}')">🖕</span>
    <span class="emoji-option" style="font-size: 14px;" wire:click="addEmoji('&#9994','{{ $data['employee']->emp_id }}')">✊</span>
    <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128074','{{ $data['employee']->emp_id }}'))">👊</span>
    <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128077','{{ $data['employee']->emp_id }}'))">👍	</span>
    <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128078','{{ $data['employee']->emp_id }}')">👎</span>
                
    </div>
    <div class="emoji-row">
    <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#129307','{{ $data['employee']->emp_id }}')">🤛</span>
    <span class="emoji-option" style="font-size: 14px;" wire:click="addEmoji('&#9996','{{ $data['employee']->emp_id }}')">✌</span>
    <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#128076','{{ $data['employee']->emp_id }}')">👌</span>
    <span class="emoji-option" style="font-size: 14px;"  wire:click="addEmoji('&#129295','{{ $data['employee']->emp_id }}')">🤏</span>
    ...
    @if($currentCardComments && $currentCardComments->count() > 0)
        @foreach ($currentCardComments as $comment)
            ...
            <img style="border-radius: 50%; margin-left: 10px;" height="35" width="35" src="{{ asset('storage/' . $comment->image) }}">

                <div class="comment" style="font-size: 12px; font-family: 'Open Sans', sans-serif; ">
                <b style="color:grey;font-weight:600">{{ ucwords(strtolower($comment->first_name)) }} {{ ucwords(strtolower($comment->last_name)) }}</b>
            ...
            <div class="hire-card">
                ...
                <div class="F"
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-md-8 m-auto">
                            <p style="font-size:12px;color:#778899;font-weight:500;">
                            {{ ucwords(strtolower($data['employee']->first_name)) }}
    {{ ucwords(strtolower($data['employee']->last_name)) }}, has joined us
                            ...
                            @endif
                                <p style="margin-left: 10px; font-size: 12px; color: black;margin-bottom:0;">
                                {{ ucwords(strtolower($data['employee']->first_name)) }}
    {{ ucwords(strtolower($data['employee']->last_name)) }}, Just
                                    Joined Us!
                                </p>
                            </div>
                        </div>
...
<div class="w-90" style="border-top: 1px solid #E8E5E4; margin: 10px;"></div>
    ...
    <div id="emoji-list-{{ $index }}" class="emoji-list" style="display: none;background:white; border-radius:5px; border:1px solid silver; max-height:170px;width:220px; overflow-y: auto;">
    <div class="emoji-row">
    <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128512','{{ $data['employee']->emp_id }}')">😀</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128513','{{ $data['employee']->emp_id }}')">😁</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128514','{{ $data['employee']->emp_id }}')">😂</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128515','{{ $data['employee']->emp_id }}')">😃</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128516','{{ $data['employee']->emp_id }}')">😄</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128517','{{ $data['employee']->emp_id }}')">😅</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128518','{{ $data['employee']->emp_id }}')">😆</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128519','{{ $data['employee']->emp_id }}')">😇</span>
          
    </div>
<div class="emoji-row">
<span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128520','{{ $data['employee']->emp_id }}')">😈</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128521','{{ $data['employee']->emp_id }}')">😉</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128522','{{ $data['employee']->emp_id }}')">😊</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128523','{{ $data['employee']->emp_id }}')">😋</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128525','{{ $data['employee']->emp_id }}')">😍</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128524','{{ $data['employee']->emp_id }}')">😌</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128526','{{ $data['employee']->emp_id }}'))">😎</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128527','{{ $data['employee']->emp_id }}'))">😏</span>
           
</div>
<div class="emoji-row">
<span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128528','{{ $data['employee']->emp_id }}')">😐</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128529','{{ $data['employee']->emp_id }}')">😑	</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128530','{{ $data['employee']->emp_id }}')">😒</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128531','{{ $data['employee']->emp_id }}')">😓</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128532','{{ $data['employee']->emp_id }}')">😔</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128533','{{ $data['employee']->emp_id }}')">😕</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128534','{{ $data['employee']->emp_id }}')">😖</span>
            <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128535','{{ $data['employee']->emp_id }}')">😗</span>
...
<div class="emoji-row">
    ...
    <div  class="emoji-row">
    <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128072','{{ $data['employee']->emp_id }}')">👈</span>
    <span class="emoji-option" style="font-size: 14px;" wire:click="selectEmoji('&#128073','{{ $data['employee']->emp_id }}')">👉</span>
    <span class="emoji-option" style="font-size: 14px;" wire:click="selectEmoji('&#128405','{{ $data['employee']->emp_id }}')">🖕</span>
    <span class="emoji-option" style="font-size: 14px;" wire:click="selectEmoji('&#9994','{{ $data['employee']->emp_id }}')">✊</span>
    <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128074','{{ $data['employee']->emp_id }}'))">👊</span>
    <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128077','{{ $data['employee']->emp_id }}'))">👍	</span>
    <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128078','{{ $data['employee']->emp_id }}')">👎</span>
                
    </div>
    <div class="emoji-row">
    <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#129307','{{ $data['employee']->emp_id }}')">🤛</span>
    <span class="emoji-option" style="font-size: 14px;" wire:click="selectEmoji('&#9996','{{ $data['employee']->emp_id }}')">✌</span>
    <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#128076','{{ $data['employee']->emp_id }}')">👌</span>
    <span class="emoji-option" style="font-size: 14px;"  wire:click="selectEmoji('&#129295','{{ $data['employee']->emp_id }}')">🤏</span>
        ...
        @foreach ($currentCardComments as $comment)
          <!-- Check if the comment has an associated employee -->
            ...
            <img style="border-radius: 50%; margin-left: 10px;" height="35" width="35" src="{{ asset('storage/' . $comment->image) }}">
                ...
                <div class="comment" style="font-size: 12px; margin-left: 20px;">
                <b style="color:grey;font-weight:600">{{ ucwords(strtolower($comment->first_name)) }} {{ ucwords(strtolower($comment->last_name)) }}</b>
