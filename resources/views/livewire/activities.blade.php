<div>
<div wire:loading
        wire:target="addFeeds,submit,file_path,openEmojiDialog,openDialog,closeEmojiDialog,handleRadioChange,closeFeeds">
                            ...
                            <div class="cards">
                                ...
                                <div class="row m-0 mt-3 align-items-center">
                                    ...
                                    <div class="col-3 text-center">
                                        ...
                                        <img class="rounded-circle" height="50" width="50" src="data:image/jpeg;base64,{{$employee->image}}" alt="Manager Image">
                                        @else
