<div>
    ...
    <div class="row  p-0" style="margin:0 10px;">
            ...
            <div class="row p-0 " id="personalDetails" style=" margin:20px auto;">
                <div class="col">
                    <div class="row" style="border-radius: 5px; height: 270px; width: 100%; background-color: white; margin-bottom: 20px;">
                        ...
                        <div class="col">
                            @if($employeeDetails && $employeeDetails->empPersonalInfo)
                            <div class="employee-profile-image-container" style="margin-left: 15px;">
                                <img height="80" src="{{ asset('storage/' .  $employeeDetails->empPersonalInfo->image) }}" class="employee-profile-image">
                            </div>
                            @else
                            <div class="employee-profile-image-container" style="margin-left: 15px;">
                    ...
                    <div class="row" style="border-radius: 5px; height: 270px; width: 100%; background-color: white;margin-bottom: 20px;">
                        ...
                        <div class="col">
                            ...
                            <div style="margin-left: 15px; font-size: 12px">
                                {{$employeeDetails->empPersonalInfo->blood_group ? $employeeDetails->empPersonalInfo->blood_group : '-'}}
                            </div>
                            <div style="margin-top: 20px; font-size: 11px; color: #778899; margin-left: 15px;">
                                Marital Status
                            </div>
                            <div style="margin-left: 15px; font-size: 12px">
                                {{ $employeeDetails->empPersonalInfo->marital_status 
        ? ucwords(strtolower($employeeDetails->empPersonalInfo->marital_status)) 
        : '-' }}
                            </div>
                            ...
                            <div style="margin-left: 15px; font-size: 12px">
                                {{$employeeDetails->empPersonalInfo->city ? $employeeDetails->empPersonalInfo->city : '-'}}
                            </div>
                            <div style="font-size: 11px; margin-top: 20px; color: #778899; margin-left: 15px">
                                Religion
                            </div>
                            ...
                            <div style="margin-left: 15px; font-size: 12px;margin-bottom:10px;">
                                {{$employeeDetails->empPersonalInfo->religion ? $employeeDetails->empPersonalInfo->religion : '-'}}
                            </div>
        ...
        : '-' }}
                            ...
                            <div style="margin-left: 15px; font-size: 12px;">
                                {{$employeeDetails->empPersonalInfo->physically_challenge ? ucwords(strtolower($employeeDetails->empPersonalInfo->physically_challenge)) : '-'}}
                            </div>
                        </div>
                        <div class="col">
                            <div style="font-size: 11px; color: #778899; margin-left: 15px">
                            ...
                            <div style="margin-left: 15px; font-size: 12px">
                                {{$employeeDetails->empPersonalInfo->nationality ? $employeeDetails->empPersonalInfo->nationality : '-'}}
                            </div>
                            <div style="margin-top: 20px; font-size: 11px; color: #778899; margin-left: 15px">
                                Spouse
                            </div>
                            ...
                            <div style="margin-left: 15px; font-size: 12px">
                                {{$employeeDetails->empSpouseDetails->name ? $employeeDetails->empSpouseDetails->name : '-'}}
                            </div>
                            ...
                            <div style="margin-left: 15px; font-size: 12px">
                                {{ $employeeDetails->empParentDetails && $employeeDetails->empParentDetails->father_first_name && $employeeDetails->empParentDetails->father_last_name 
        ? ucwords(strtolower($employeeDetails->empParentDetails->father_first_name)) . ' ' . ucwords(strtolower($employeeDetails->empParentDetails->father_last_name))
        : '-' }}
                            </div>
                    ...
                    <div class="row" style="border-radius: 5px; height: 200px; width: 100%; background-color: white; margin-bottom: 20px;">
                        ...
                        <div class="col">
                            ...
                            <div style="margin-left: 15px; font-size: 11px;color:#000;">
                                {{$employeeDetails->empPersonalInfo->permenant_address ? $employeeDetails->empPersonalInfo->permenant_address : '-'}}
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div style="margin-left: 15px; font-size: 11px;color:#000;">
                                {{$employeeDetails->empPersonalInfo->present_address ? $employeeDetails->empPersonalInfo->present_address : '-'}}
                            </div>
                            ...
                            <div style="margin-left: 15px; font-size: 12px">
                                {{$employeeDetails->empPersonalInfo->mobile_number ? $employeeDetails->empPersonalInfo->mobile_number : '-'}}
                            </div>
                        </div>
                        <div class="col">
                            <div style="font-size: 11px;  color: #778899; margin-left: 15px">
            ...
            <div class="row" style="margin:20px auto;border-radius: 5px;display: none;" id="familyDetails">
                <div class="col">
                    <div class="row" style="border-radius: 5px; height: 200px; width: 100%; background-color: white; margin-bottom: 20px;">
                        ...
                        <div class="col-3">
                            <img style="border-radius: 5px;" height="150" width="150" src="{{$employeeDetails->empParentDetails->father_image}}" alt="">
                        </div>
                        <div class="col-3">
                            <div style="font-size: 12px; margin-top: 20px; color: #778899;">
                                Father Name
                            </div>
                            ...
                            <div style=" font-size: 12px;width:250px">
                                {{$employeeDetails->empParentDetails->father_address}},{{$employeeDetails->empParentDetails->father_city}},{{$employeeDetails->empParentDetails->father_state}},{{$employeeDetails->empParentDetails->father_country}}
                            </div>
                        </div>
                        <div class="col-2">
                            <div style="font-size: 12px; margin-top: 20px; color: #778899; ">
                            ...
                            <div style=" font-size: 12px">
                                {{$employeeDetails->empParentDetails->father_nationality}}
                            </div>
                        </div>
                        <div class="col-2">
                            <div style="font-size: 12px; margin-top: 20px; color: #778899; ">
                            ...
                            <div style=" font-size: 12px">
                                {{$employeeDetails->empParentDetails->father_blood_group}}
                            </div>
                            <div style="font-size: 12px; margin-top: 20px; color: #778899; ">
                                Occupation
                            </div>
                            <div style=" font-size: 12px">
                                {{$employeeDetails->empParentDetails->father_occupation}}
                            </div>
                        </div>
                        <div class="col-2" style="width: 100%; overflow-wrap: break-word;">
                            <div style="font-size: 12px; margin-top: 20px; color: #778899; ">
                                Religion
                            </div>
                            <div style="font-size: 12px; word-wrap: break-word;">
                                {{ $employeeDetails->empParentDetails->father_religion }}
                            </div>
                            <div style="font-size: 12px; margin-top: 20px; color: #778899; ">
                                Father Email
                            </div>
                            <div style=" font-size: 12px; word-wrap: break-word; white-space: normal;">
                                {{ $employeeDetails->empParentDetails->father_email }}
                            </div>
                        </div>
                    ...
                    <div class="row" style="border-radius: 5px; height: 200px; width: 100%; background-color: white; margin-bottom: 20px;">
                        ...
                        <div class="col-3">
                            <img style="border-radius: 5px;" height="150" width="150" src="{{$employeeDetails->empParentDetails->mother_image}}" alt="">
                        </div>
                        <div class="col-3">
                            <div style="font-size: 12px; margin-top: 20px; color: #778899;">
                                Mother Name
                            ...
                            <div style=" font-size: 12px">
                                {{ucwords(strtolower($employeeDetails->empParentDetails->mother_first_name))}} {{ucwords(strtolower($employeeDetails->empParentDetails->mother_last_name))}}
                            </div>
                            <div style="font-size: 12px; margin-top: 20px; color: #778899; ">
                                Address
                            </div>
                            <div style=" font-size: 12px;width:250px">
                                {{$employeeDetails->empParentDetails->mother_address}},{{$employeeDetails->empParentDetails->mother_city}},{{$employeeDetails->empParentDetails->mother_state}},{{$employeeDetails->empParentDetails->mother_country}}
                            </div>
                        </div>
                        <div class="col-2">
                            <div style="font-size: 12px; margin-top: 20px; color: #778899; ">
                            ...
                            <div style=" font-size: 12px">
                                {{$employeeDetails->empParentDetails->mother_nationality}}
                            </div>
                        </div>
                        <div class="col-2">
                            <div style="font-size: 12px; margin-top: 20px; color: #778899; ">
                            ...
                            <div style=" font-size: 12px">
                                {{$employeeDetails->empParentDetails->mother_blood_group}}
                            </div>
                            <div style="font-size: 12px; margin-top: 20px; color: #778899;">
                                Occupation
                            </div>
                            <div style=" font-size: 12px">
                                {{$employeeDetails->empParentDetails->mother_occupation}}
                            </div>
                        </div>
                        <div class="col-2" style="width: 100%; overflow-wrap: break-word; word-wrap: break-word;">
                            <div style="font-size: 12px; margin-top: 20px; color: #778899;">
                                Religion
                            </div>
                            <div style="font-size: 12px">
                                {{ $employeeDetails->empParentDetails->mother_religion }}
                            </div>
                            <div style="font-size: 12px; margin-top: 20px; color: #778899;">
                                Mother Email
                            </div>
                            <div style="font-size: 12px; white-space: normal; overflow-wrap: break-word;">
                                {{ $employeeDetails->empParentDetails->mother_email }}
                            </div>
                        </div>
            ...
            <div class="row" style="margin:20px auto;border-radius: 5px;display: none;" id="employeeJobDetails">
                <div class="col">
                    <div class="row" style="border-radius: 5px; height: 250px; width: 100%; background-color: white; margin-bottom: 20px;">
                        ...
                        $manager = \App\Models\EmployeeDetails::where('emp_id', $employeeDetails->manager_id)->first();
                        @endphp
                        ...
                        <div class="col">
                            ...
                            <div style="margin-left: 15px; font-size: 12px;">
                                @if($manager)
                                {{ ucwords(strtolower($manager->first_name)) }} {{ ucwords(strtolower($manager->last_name)) }}
                                @else
                                No Manager Assigned
                                @endif
                            </div>
                        ...
                        <div class="col">
                            ...
                            $department = \App\Models\EmpDepartment::where('dept_id', $employeeDetails->dept_id)->first();
                            @endphp
                            ...
                            @php
                            // Fetch the department name directly in Blade
                            $subDepartment = \App\Models\EmpSubDepartments::where('sub_dept_id', $employeeDetails->sub_dept_id)->first();
                            @endphp
                ...
                <div class="col">
                    <div class="row" style="border-radius: 5px; height: 200px; width: 100%; background-color: white; margin-bottom: 20px;">
                        ...
                        <div class="col">
                            ...
                            <div style="margin-left: 15px; font-size: 12px">
                                {{$employeeDetails->empPersonalInfo->adhar_no}}
                            </div>
                            <div style="margin-top: 20px; font-size: 11px; color: #778899; margin-left: 15px">
                                PREVIOUS
                            </div>
