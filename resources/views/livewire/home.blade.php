<div class="position-relative">
    <div class="position-absolute" wire:loading wire:target="open,toggleSignState,getThisMonthLeaves,getTodayLeaves,closeThisMonthLeaves,closeTodayLeaves">
            ...
            <div class="payslip-card  mb-4">
                <div class="reviews">
                    <div>
                        ...
                        @endfor
                        @if ($teamCount > 3)
                        <div class="remainContent d-flex mt-1 flex-column align-items-center" wire:click="getTodayLeaves">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="mt-2 d-flex align-items-center gap-2 mb-3">
                                ...
                                <div
                                    class="remainContent d-flex flex-column align-items-center" wire:click="getThisMonthLeaves">
                                    <!-- Placeholder color -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer d-flex align-items-center justify-content-center">
                            <button type="button" class="cancel-btn" wire:click="closeThisMonthLeaves"
                                style="border:1px solid rgb(2,17,79);" data-dismiss="modal">Close</button>
                        </div>
                        @endif
                        ...
                        <div class="d-flex flex-row gap-2 mb-3">
                            ...
                            @foreach ($teamOnLeaveRequests as $requests)
                                ...
                                <div class="d-flex align-items-center ">
                                    <div class="thisCircle"
                                        style="border: 1px solid {{ $randomColorLeaveList }}" data-toggle="tooltip" data-placement="top"
                                        title="{{ ucwords(strtolower($requests->employee->first_name)) }} {{ ucwords(strtolower($requests->employee->last_name)) }}">
                                        <span>{{ substr($requests->employee->first_name, 0, 1) }}{{ substr($requests->employee->last_name, 0, 1) }}
                                        </span>
                                    </div>
