            ...
            <div class="col-md-6 mb-3">
                <div class="row m-0" style="border-radius: 10px; background-color: #02114f;">
                    <div class="col-7 p-0 ps-3 pt-4">
                        ...
                        @endif
                        <p class="morning-city">Welcome, {{ ucwords(strtolower($loginEmployee->first_name)) }}
                            {{ ucwords(strtolower($loginEmployee->last_name)) }}</p>
                    </div>
                    <!-- Assuming you have a Livewire component rendering this -->
                    <div class="col-5 p-0">
                            ...
                            <div class="morning-card w-100">
                                ...
                                <div class="morning-minmaxContainer">
                                    ...
                                    <div class="morning-max">
                                        <p class="morning-minTemp">Wind direction</p>
                                        <p class="morning-minHeading">{{ $winddirection }}°</p>
                                    </div>
                                </div>
                            </div>
                        </div>
