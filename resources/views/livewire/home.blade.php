                ...
                <div class="cardReport">
                    ...
                    <div class="bottom">
                        <div class="content">
                            ...
                            <span class="name" title="{{ ucwords(strtolower($loginEmpManagerDetails->first_name)) }} {{ ucwords(strtolower($loginEmpManagerDetails->last_name)) }}">
                                {{ ucwords(strtolower($loginEmpManagerDetails->first_name)) }} {{ ucwords(strtolower($loginEmpManagerDetails->last_name)) }}
                                <br>
                                <span class="about-me">
                                    @php
