...
<body>
    ...
    <div>
        ...
        <div class="row m-0 p-0" style="height: 100vh;background:#f2f2f2;">

            <div class="menucard displayNone hideMinBar" id="menu-popup" style="border-radius:0px; width: auto; background:#fff;box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);padding:0;margin:0;">
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="leave-options" style="display: none;">
                                        <ul style="list-style: none;  margin-left:10px; cursor:pointer;">
                                            <li data-bs-toggle="modal" data-bs-target="#navigateLoader" class="nav-item">
                                                <a class="nav-link" href="/leave-page" onclick="csetActiveLink(this)">
                                                    Leave Apply
                                                </a>
                                            </li>
                                            <li data-bs-toggle="modal" data-bs-target="#navigateLoader" class="nav-item">
                                ...
                                <li data-bs-toggle="modal" data-bs-target="#navigateLoader" class="nav-item">
                                    ...
                                    <a class="nav-link" href="/delegates" onclick="setActiveLink(this)">
                                        ...
                                        <i class="fas mr-1    fa-user-friends" style="color:#6c7e90"></i> Workflow Delegates
            ...
            <div onmouseleave="myMenuSmallHover()" class="menucard displayNone hideMinBar" id="menu-popup-hover" style="position: absolute; z-index: 1; border-radius:0px; width: auto; background:#fff;box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);padding:0;margin:0;">
            ...
            <div class="menucard displayNone" onclick="myMenuSmallHover()" id="menu-small" style="border-radius:0px; width: 5%; background:#fff;box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);padding:0;margin:0;">
            ...
            <div class="col m-0 px-2 align-items-center" style="height: 60px; width: auto; background: url('images/imageedit_1_3636168378.png') no-repeat center #02114f; background-size: cover">

                <div class="col" style="display: flex; align-items: center; justify-content: end;margin-top: 10px;">
                    ...
                    <h6 class="mx-2 my-0" style="color: white; width: -webkit-fill-available;"> @livewire('page-title')</h6>
                    <input type="text" class="form-control showHamburger w-50 p-1 bg-light" placeholder="Search..." aria-label="Username" aria-describedby="basic-addon1">
                    ...
                    <div class="notification-icon ">
                        <i style="color: white; position: relative;" class="fas mr-1 fa-bell">
                            <span class="badge bg-danger" style="position: absolute; top: -9px; right: -1px; font-size:10px;">4</span>
                        </i>
                    </div>
