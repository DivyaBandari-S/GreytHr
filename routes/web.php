...
Route::middleware(['auth:hr'])->group(function () {
    ...
    Route::get('/hremployeedirectory', EmployeeDirectory::class)->name('hremployeedirectory');
    Route::get('/hrorganisationchart', OrganisationChart::class)->name('hrorganisationchart');
