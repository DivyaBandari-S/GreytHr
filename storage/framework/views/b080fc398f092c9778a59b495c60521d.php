<div>
    <!--[if BLOCK]><![endif]--><?php if($showAttendanceRegularisationReportDialog==true): ?>
    <div class="modal-body" style="max-height:300px;overflow-y:auto">
        ...
        <table class="swipes-table mt-2 border" style="width: 100%;">
            ...
            <tr style="border:1px solid #ccc;">
                ...
                <td style="width:50%;font-size: 10px; color:  <?php echo ($emp->employee_status == 'active') ? '#778899' : '#f66'; ?>;text-align:start;padding:5px 10px;white-space:nowrap;"><?php echo e(ucwords(strtolower($emp->first_name))); ?> <?php echo e(ucwords(strtolower($emp->last_name))); ?></td>
                <td style="width:50%;font-size: 10px; color:  <?php echo ($emp->employee_status == 'active') ? '#778899' : '#f66'; ?>;text-align:start;padding:5px 10px;white-space:nowrap;"><?php echo e($emp->emp_id); ?></td>
...
</div><?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/attendance-regularisation-report.blade.php ENDPATH**/ ?>