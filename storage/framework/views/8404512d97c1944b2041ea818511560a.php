    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="color: #3b4452;">
        ...
        <div class="row mt-3 d-flex" style="overflow-x: hidden;">
            ...
            <div class="col-md-4 bg-white p-3" style="border-radius:5px;border:1px solid silver;height:auto;overflow-x: hidden;">
                ...
                <div id="activitiesSection" class="activities" style="width: 100%; height: 30px;">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.min.js" integrity="sha384-BBtl+eGJRgqQAUMxJ7pMwbEyER4l1g+O15P+16Ep7Q9Q+zqX6gSbd85u4mG4QzX+" crossorigin="anonymous"></script> -->
    ...
    function filterDropdowns() {
        var input, filter, uls, ul, lis, a, i, j, hasMatch;
        ...
        for (i = 0; i < uls.length; i++) {
            ...
            hasMatch = false; // Reset match flag for each ul
            
            for (j = 0; j < lis.length; j++) {
                a = lis[j];
                if (a.innerHTML.toUpperCase().indexOf(filter) > -1) {
                    lis[j].style.display = ""; // Show matching item
                    hasMatch = true; // Found a match
                } else {
                    lis[j].style.display = "none"; // Hide non-matching item
                }
            }
            
            // Show dropdown if there's at least one matching item
            var dropdownContent = ul.parentElement.querySelector('div[id^="dropdownContent"]');
            if (hasMatch) {
                dropdownContent.style.display = "block"; // Show dropdown
            } else {
                dropdownContent.style.display = "none"; // Hide dropdown if no match
            }
        }
    }
</script>
