                        ...
                        <div class="col-md-4 mb-4">
                            <div style="background:white;border:1px solid #d3d3d3;border-radius:5px; padding: 10px 15px;">
                                ...
                                <div class="row m-0">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($AddRequestaceessDialog): ?>
                                    <div class="modal" tabindex="-1" role="dialog" style="<?php echo e($showModal ? 'display: block;' : 'display: none;'); ?>">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form wire:submit.prevent="DistributorRequest">
                                                        ...
                                                        <div class="form-group mt-2">
                                                            ...
                                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['distributor_name'];
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="form-group  m-0 p-0">
                                                                        <label for="cc_to" > Members to be Added :<span style="font-size:12px"> <?php echo e(implode(', ', array_unique($selectedPeopleNames))); ?></span></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="input-group-append" style="display: flex; align-items: center;">
        ...
        <?php else: ?>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $peopleData->sortBy(function($people) { return strtolower($people->first_name) . ' ' . strtolower($people->last_name); }); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $people): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label wire:click="selectPerson('<?php echo e($people->emp_id); ?>')" class="container" style="cursor: pointer; background-color: darkgrey; padding: 5px; margin-top: 10px; width: 300px; border-radius: 5px;">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            <input wire:model="image" type="file" accept="image/*" style="font-size: 12px;">
                                    ...
                                    <div class="modal-backdrop fade show blurred-backdrop" style="<?php echo e($showModal ? '' : 'display: none;'); ?>"></div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-md-4 mb-4">
                            <div style="background:white; border:1px solid #d3d3d3; border-radius:5px; padding: 10px 15px;">
                                ...
                                <div class="row m-0">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($ItRequestaceessDialog): ?>
                                    <div class="modal" tabindex="-1" role="dialog" style="<?php echo e($showModal ? 'display: block;' : 'display: none;'); ?>">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form wire:submit.prevent="submit">
                                                        ...
                                                        <div class="form-group mt-2" >
                                                            ...
                                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selected_equipment'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                                        ...
                                                        <div class="form-group ml-1" >
                                                            <div class="row">
                                                                <div class="form-group ">
                                                                    <label for="cc_to" class="form-label ">Request For : <span style="font-size:12px"> <?php echo e(implode(', ', array_unique($selectedPeopleNames))); ?></span></label>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger" style="margin-left:20px"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                                                </div>
                        ...
                        <div class="col-md-4 mb-4">
                            <div style="background:white; border:1px solid #d3d3d3; border-radius:5px; padding: 10px 15px;">
                                ...
                                <div class="row m-0">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($MailRequestaceessDialog): ?>
                                    <div class="modal" tabindex="-1" role="dialog" style="<?php echo e($showModal ? 'display: block;' : 'display: none;'); ?>">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="form-group ">
                                                                    <label for="cc_to" class="form-label" >Add users to be a New Mailbox : <span style="font-size:12px"> <?php echo e(implode(', ', array_unique($selectedPeopleNames))); ?></span></label>
                            ...
                            <div class="col-md-4 mb-4">
                                <div style="background:white; border:1px solid #d3d3d3; border-radius:5px; padding: 10px 15px;">
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($IdRequestaceessDialog): ?>
                                        <div class="modal" tabindex="-1" role="dialog" style="<?php echo e($showModal ? 'display: block;' : 'display: none;'); ?>">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                            ...
                            <div class="col-md-4 mb-4">
                                <div style="background:white; border:1px solid #d3d3d3; border-radius:5px; padding: 10px 15px;">
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($MmsRequestaceessDialog): ?>
                                        <div class="modal" tabindex="-1" role="dialog" style="<?php echo e($showModal ? 'display: block;' : 'display: none;'); ?>">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                            ...
                            <div class="col-md-4 mb-4">
                                <div style="background:white; border:1px solid #d3d3d3; border-radius:5px; padding: 10px 15px;">
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($DistributionRequestaceessDialog): ?>
                                        <div class="modal" tabindex="-1" role="dialog" style="<?php echo e($showModal ? 'display: block;' : 'display: none;'); ?>">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                            ...
                                                            <div class="row m-0" style="margin-left:-10px">
                                                                <div class="row">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group m-0 p-0">
                                                                            <label for="cc_to" class="form-label" style="margin-left:-13px"> Members to be Added :<span style="font-size:12px"> <?php echo e(implode(', ', array_unique($selectedPeopleNames))); ?></span></label>
                            ...
                            <div class="col-md-4 mb-4">
                                <div style="background:white; border:1px solid #d3d3d3; border-radius:5px; padding: 10px 15px;">
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($LapRequestaceessDialog): ?>
                                        <div class="modal" tabindex="-1" role="dialog" style="<?php echo e($showModal ? 'display: block;' : 'display: none;'); ?>">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                            ...
                            <div class="col-md-4 mb-4">
                                <div style="background:white; border:1px solid #d3d3d3; border-radius:5px; padding: 10px 15px;">
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($DevopsRequestaceessDialog): ?>
                                        <div class="modal" tabindex="-1" role="dialog" style="<?php echo e($showModal ? 'display: block;' : 'display: none;'); ?>">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
...
<?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/catalog.blade.php ENDPATH**/ ?>