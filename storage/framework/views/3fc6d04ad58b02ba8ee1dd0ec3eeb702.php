<div class="leavePageContent">
   ...
   <div class="toggle-container">
      ...
      <div class="nav-buttons d-flex justify-content-center">
         <ul class="nav custom-nav-tabs border">
            <li class="custom-item m-0 p-0 flex-grow-1">
               <div style="border-top-left-radius:5px; border-bottom-left-radius:5px;" class="custom-nav-link <?php echo e($activeSection === 'applyButton' ? 'active' : ''); ?>" wire:click.prevent="toggleSection('applyButton')">Apply</div>
            </li>
            <li class="custom-item m-0 p-0 flex-grow-1" style="border-left:1px solid #ccc; border-right:1px solid #ccc;">
               <a href="#" style="border-radius:none;" class="custom-nav-link <?php echo e($activeSection === 'pendingButton' ? 'active' : ''); ?>" wire:click.prevent="toggleSection('pendingButton')">Pending</a>
            </li>
            <li class="custom-item m-0 p-0 flex-grow-1">
               <a href="#" style="border-top-right-radius:5px; border-bottom-right-radius:5px;" class="custom-nav-link <?php echo e($activeSection === 'historyButton' ? 'active' : ''); ?>" wire:click.prevent="toggleSection('historyButton')">History</a>
            </li>
         </ul>
      </div>
      ...
      <div class="content-sections mt-3">
         <!--[if BLOCK]><![endif]--><?php if($activeSection === 'applyButton'): ?>
         <div class="containerWidth">
            <div id="cardElement" class="side">
               <div>
                  <a href="#" class="side-nav-link <?php echo e($activeSubSection === 'leave' ? 'active' : ''); ?>" wire:click.prevent="toggleSideSection('leave')">Leave</a>
               </div>
               <div class="line"></div>
               <div>
                  <a href="#" class="side-nav-link <?php echo e($activeSubSection === 'restricted' ? 'active' : ''); ?>" wire:click.prevent="toggleSideSection('restricted')">Restricted Holiday</a>
               </div>
               <div class="line"></div>
               <div>
                  <a href="#" class="side-nav-link <?php echo e($activeSubSection === 'leaveCancel' ? 'active' : ''); ?>" wire:click.prevent="toggleSideSection('leaveCancel')">Leave Cancel</a>
               </div>
               <div class="line"></div>
               <div>
                  <a href="#" class="side-nav-link <?php echo e($activeSubSection === 'compOff' ? 'active' : ''); ?>" wire:click.prevent="toggleSideSection('compOff')">Comp Off Grant</a>
               </div>
            </div>
         </div>

         <!-- Sub-Section Content -->
         <!--[if BLOCK]><![endif]--><?php if($activeSubSection === 'leave'): ?>
         <div class="apply-section">
            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('leave-apply-page');

$__html = app('livewire')->mount($__name, $__params, 'lw-2993604724-0', $__slots ?? [], get_defined_vars());
...
?>
         ...
         <?php elseif($activeSubSection === 'restricted'): ?>
         ...
         <?php elseif($activeSubSection === 'leaveCancel'): ?>
...
[$__name, $__params] = $__split('leave-cancel-page');

$__html = app('livewire')->mount($__name, $__params, 'lw-2993604724-1', $__slots ?? [], get_defined_vars());
...
?>
         ...
         <?php elseif($activeSubSection === 'compOff'): ?>
         ...
         <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
         <?php elseif($activeSection === 'pendingButton'): ?>
         ...
         <?php elseif($activeSection === 'historyButton'): ?>
...
</script><?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/leave-form-page.blade.php ENDPATH**/ ?>