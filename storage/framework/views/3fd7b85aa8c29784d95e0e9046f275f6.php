    ...
    <div class="card border-0 m-0" style="width: 380px; border-radius: 5px;">
        <div class="card-header px-0 py-0 m-0 border-0 " style="border-radius: 5px;">
            <div class="row no-gutters" style="height: 100%; width: 100%;">
                <div class="col">
                    <button wire:click="$set('activeTab', 'active')" class="btn btn-block <?php if($activeTab === 'active'): ?> active <?php else: ?> btn-light <?php endif; ?>" style="font-size: 13px; font-weight: 500; border-radius: 5px 0 0 5px; background-color: <?php if($activeTab === 'active'): ?> rgb(2, 17, 79) <?php else: ?> none <?php endif; ?>; color: <?php if($activeTab === 'active'): ?> #fff <?php else: ?> #778899 <?php endif; ?>; height: 100%;">
                        Active
                    </button>
                </div>
                <div class="col">
                    <button wire:click="$set('activeTab', 'pending')" class="btn btn-block <?php if($activeTab === 'pending'): ?> active <?php else: ?> btn-light <?php endif; ?>" style="font-size: 13px; font-weight: 500; border-radius: 0; background-color: <?php if($activeTab === 'pending'): ?> rgb(2, 17, 79) <?php else: ?> none <?php endif; ?>; color: <?php if($activeTab === 'pending'): ?> #fff <?php else: ?> #778899 <?php endif; ?>; height: 100%;">
                        Pending
                    </button>
                </div>
                <div class="col">
                    <button wire:click="$set('activeTab', 'closed')" class="btn btn-block <?php if($activeTab === 'closed'): ?> active <?php else: ?> btn-light <?php endif; ?>" style="font-size: 13px; font-weight: 500; border-radius: 0 5px 5px 0; background-color: <?php if($activeTab === 'closed'): ?> rgb(2, 17, 79) <?php else: ?> none <?php endif; ?>; color: <?php if($activeTab === 'closed'): ?> #fff <?php else: ?> #778899 <?php endif; ?>; height: 100%;">
                        Closed
                    </button>
                </div>
            </div>
                                ...
                                <div class="row m-0 p-0">
                                    <div class="row m-0 p-0">
                                        <div style="margin: 0px;padding:0;">
                                            <div>
                                                <div style="font-size: 12px;color:#778899;margin-bottom:10px;font-weight:500;" wire:model="cc_to" id="cc_to">Selected CC recipients : <?php echo e(implode(', ', array_unique($selectedPeopleNames))); ?></div>
                                            </div>
                                ...
                                <button wire:click="closePeoples"  type="button" class="close rounded px-1 py-0" aria-label="Close" style="background-color: rgb(2,17,79);height:32px;width:33px;">
                                    ...
                                    <label wire:click="selectPerson('<?php echo e($people->emp_id); ?>')" class="container" style="cursor: pointer; background-color: darkgrey; padding: 5px; margin-bottom: 8px; width: 300px; border-radius: 5px;">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <input type="checkbox" wire:model="selectedPeople" id="cc_to" value="<?php echo e($people->emp_id); ?>">
                                            </div>
                                            <div class="col-auto">
                            ...
                            <div class="col">
                                <div class="row m-0 p-0">
                                    <div class="row m-0 p-0">
                                        <div style="margin: 0px;padding:0;">
                                            <div>
                                                <div style="font-size: 12px;color:#778899;margin-bottom:10px;font-weight:500;">Selected CC recipients : <?php echo e(implode(', ', array_unique($selectedPeopleNames))); ?></div>
                                            </div>
                                            <button type="button" style="border-radius: 50%;margin-right:10px;color:#778899;border:1px solid #778899;" class="add-button" wire:click="toggleRotation">
                                                <i class="fa fa-plus" style="color:#778899;"></i>
                                            </button><span style="color:#778899;font-size:12px;">Add</span>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <button wire:click="closePeoples"  type="button" class="close rounded px-1 py-0" aria-label="Close" style="background-color: rgb(2,17,79);height:32px;width:33px;">
                                    ...
                                    <label wire:click="selectPerson('<?php echo e($people->emp_id); ?>')" class="container" style="cursor: pointer; background-color: darkgrey; padding: 5px; margin-bottom: 8px; width: 300px; border-radius: 5px;">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <input type="checkbox" wire:model="selectedPeople" value="<?php echo e($people->emp_id); ?>">
                                            </div>
                                            <div class="col-auto">
                                                <!--[if BLOCK]><![endif]--><?php if($people->image==""): ?>
                                                <!--[if BLOCK]><![endif]--><?php if($people->gender=="Male"): ?>
    ...
    <div class="card-body" style="margin: 0 auto; background-color: white; width: 95%; height: 400px; margin-top: 30px; border-radius: 5px; max-height: 400px; overflow-y: auto;">
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
                <!--[if BLOCK]><![endif]--><?php if($records->where('status', 'Recent')->count() > 0): ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $records->where('status', 'Recent'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $ccToArray = explode(',', $record->cc_to);
                        ?>
                        <tr>
                            <td style="padding: 10px; font-size: 12px; text-align: center; text-transform: capitalize; width: 20%;">
                                <?php echo e(ucwords(strtolower($record->emp->first_name))); ?> <?php echo e(ucwords(strtolower($record->emp->last_name))); ?> <br> <strong style="font-size: 10px;">(<?php echo e($record->emp_id); ?>)</strong>
                            </td>
                            <td style="padding: 10px; font-size: 12px; text-align: center; text-transform: capitalize; width: 10%;"><?php echo e($record->category); ?></td>
                            <td style="padding: 10px; font-size: 12px; text-align: center; text-transform: capitalize; width: 20%;"><?php echo e($record->subject); ?></td>
                            <td style="padding: 10px; font-size: 12px; text-align: center; text-transform: capitalize; width: 10%;"><?php echo e($record->description); ?></td>
                            ...
                            <td style="padding: 10px; font-size: 12px; text-align: center; text-transform: capitalize; width: 20%;">
                                <?php echo e(count($ccToArray) <= 2 ? $record->cc_to ?? '-' : '-'); ?>

                            </td>
                            <td style="padding: 10px; font-size: 12px; text-align: center; text-transform: capitalize; width: 10%;"><?php echo e($record->priority); ?></td>
                        </tr>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="card-body" style="margin:0 auto;background-color:white;width:95%;margin-top:30px;border-radius:5px;max-height:400px;height:400px;overflow-y:auto">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php if($records->where('status', 'Completed')->count() > 0): ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $records->where('status', 'Completed'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="card-body" style="margin:0 auto;background-color:white;width:95%;margin-top:30px;border-radius:5px;max-height:400px;height:400px;overflow-y:auto">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php if($records->where('status', 'Pending')->count() > 0): ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $records->where('status', 'Pending'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td style="padding: 10px;font-size:12px;text-align:center;width:120px;text-transform: capitalize;"><?php echo e($record->emp->first_name); ?> <?php echo e($record->emp->last_name); ?> <br> <strong style="font-size: 10px;">(<?php echo e($record->emp_id); ?>)</strong></td>
                        <td style="padding: 10px;font-size:12px;text-align:center;text-transform: capitalize;"><?php echo e($record->category); ?></td>
                        <td style="padding: 10px;font-size:12px;text-align:center;text-transform: capitalize;"><?php echo e($record->subject); ?></td>
