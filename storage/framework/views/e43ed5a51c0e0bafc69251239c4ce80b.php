...
<?php else: ?>
    <div class="ytd-links">
        <div class="btn-group">
            <button class="btn btn-default <?php echo e($activeTab === 'ytd' ? 'active' : ''); ?>" wire:click="showContent('ytd')"><span class="text-capitalize">YTD Statement</span></button>
            <button class="btn btn-default <?php echo e($activeTab === 'pfytd' ? 'active' : ''); ?>" wire:click="showContent('pfytd')"><span class="text-capitalize">PF YTD Statement</span></button>
        </div>
    </div>
    <div class="row">
...
<form method="GET" action="">
            <select class="dropdown-salary bg-white px-3 py-1" name="selectedMonth" onchange="this.form.submit()">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($value); ?>" style="background-color: #fff; color: #333; font-size: 13px;" <?php echo e($selectedMonth == $value ? 'selected' : ''); ?>><?php echo e($label); ?></option>
    ...
    <div id="ytd" class="content <?php if($activeTab === 'ytd'): ?> active <?php endif; ?>">
...
<tr style="background:white">
                        ...
                        <!--[if BLOCK]><![endif]--><?php for($year = $selectedStartYear; $year <= $selectedEndYear; $year++): ?>
                            <!--[if BLOCK]><![endif]--><?php for($month = ($year == $selectedStartYear ? 4 : 1); $month <= ($year == $selectedEndYear ? 3 : 12); $month++): ?>
                                <td class="report-value">
                                    <!--[if BLOCK]><![endif]--><?php if($year < $currentYear || ($year == $currentYear && $month < $currentMonth)): ?>
        ...
        <tr style="background:white">
            ...
            <!--[if BLOCK]><![endif]--><?php for($year = $selectedStartYear; $year <= $selectedEndYear; $year++): ?>
                <!--[if BLOCK]><![endif]--><?php for($month = ($year == $selectedStartYear ? 4 : 1); $month <= ($year == $selectedEndYear ? 3 : 12); $month++): ?>
                    <td class="report-value">
                        <!--[if BLOCK]><![endif]--><?php if($year < $currentYear || ($year == $currentYear && $month < $currentMonth)): ?>
                            <?php echo e(number_format($employee->calculatePf(), 2)); ?>
        ...
        <tr style="background:white">
            ...
            <!--[if BLOCK]><![endif]--><?php for($year = $selectedStartYear; $year <= $selectedEndYear; $year++): ?>
                <!--[if BLOCK]><![endif]--><?php for($month = ($year == $selectedStartYear ? 4 : 1); $month <= ($year == $selectedEndYear ? 3 : 12); $month++): ?>
                    <td class="report-value">
                        <!--[if BLOCK]><![endif]--><?php if($year < $currentYear || ($year == $currentYear && $month < $currentMonth)): ?>
                            <?php echo e(number_format(150, 2)); ?>
        ...
        <tr style="background:white">
            ...
            <!--[if BLOCK]><![endif]--><?php for($year = $selectedStartYear; $year <= $selectedEndYear; $year++): ?>
                <!--[if BLOCK]><![endif]--><?php for($month = ($year == $selectedStartYear ? 4 : 1); $month <= ($year == $selectedEndYear ? 3 : 12); $month++): ?>
                    <td class="report-value">
                        <!--[if BLOCK]><![endif]--><?php if($year < $currentYear || ($year == $currentYear && $month < $currentMonth)): ?>
                            <?php echo e(number_format($employee->calculatePf() + 150, 2)); ?>
    ...
    <div id="pfytd" class="content <?php if($activeTab === 'pfytd'): ?> active <?php endif; ?>">
...
<div class="table-responsive mt-3">
    <table class="income-table">
        ...
        <tbody class="table-body">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $monthlyDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="background:white">
                    <td class="report-name"><?php echo e($detail['month']); ?></td>
                    <td class="report-value"><?php echo e(number_format($detail['earnings'], 2)); ?></td>
                    <td class="report-value"><?php echo e(number_format($detail['vpf'], 2)); ?></td>
                    <td class="report-value"><?php echo e(number_format($detail['pf'], 2)); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
        </tbody>
    </table>
    ...
    <div class="details-column d-flex flex-column align-items-start">
        ...
        <div class="detail align-items-start">
                <p class="emp-details-p">Employee ID <br>
                    <span class="emp-details-span"><?php echo e(ucwords(strtolower($employee->emp_id))); ?> </span>
                </p>
            </div>
            <div class="detail align-items-start">
            ...
            <div class="detail align-items-start">
                <p class="emp-details-p"> PF Number<br>
                    <span class="emp-details-span"><?php echo e(ucwords(strtolower($employee->pf_no ?? '-'))); ?></span>
                </p>
            </div>
...
<?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/ytdreport.blade.php ENDPATH**/ ?>