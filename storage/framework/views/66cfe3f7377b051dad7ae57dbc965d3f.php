<div >
<body>
    <!--[if BLOCK]><![endif]--><?php if($show=='true'): ?>
    <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('add-employee-details');

$__html = app('livewire')->mount($__name, $__params, 'lw-18131019-0', $__slots ?? [], get_defined_vars());
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane show active" id="summary-tab-pane" role="tabpanel" aria-labelledby="summary-tab" tabindex="0">
                <div class="row m-0 mb-4">
                    ...
                    <div class="col-md-5">
                        <img src="<?php echo e(asset('images/admin_banner.png')); ?>" alt="Image Description" style="width: 100%;">
                    </div>
                </div>
                <div class="row m-0">
                    <div class="col-md-8">
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="row m-0 avaPosCard">
                                    <div class="d-flex align-items-center justify-content-center mb-4 p-0 pt-2">
                                        ...
                                        <div class="col-4 p-0" >
                                            <img src="<?php echo e(asset('images/admin_banner.png')); ?>" alt="Image Description" style="width: 3em;">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="row m-0 newEpmCard">
                                    ...
                                    <div class="col-8 p-0 m-0" style="text-align: start;">
                                        <h4 class="countOfNum m-0"><?php echo e($totalNewEmployeeCount); ?></h4>
                                    </div>
                                    ...
                                    <span class="p-0 pb-3" style="color: #778899;font-size:12px;"><?php echo e($departmentCount); ?> Department</span>
                                </div>
                            </div>
                        </div>
                        <div class="row m-0">
                            <div class="col-md-6 mb-4 ">
                                <div class="row m-0 totalEmpCard">
                                    <div class="col-8  p-0 pb-5 pt-3">
                                        ...
                                        <h4 class="countOfNum"><?php echo e($totalEmployeeCount); ?>+</h4>
                                    </div>
                ...
                <div class="bg-white p-1 d-flex flex-row justify-content-between  mb-2">
                    <div class="col-8 d-flex flex-row justify-content-between mt-2 mb-4" style="text-align:start;">
                        <div class="col d-flex flex-column" style="padding: 10px 20px;border-radius: 5px;background:#ffe2c3; color:rgb(2, 17, 79); margin-right: 7px;box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
                            ...
                            <a class="text-decoration-none" href="<?php echo e(route('add-employee-details')); ?>">
                        ...
                        <div class="col d-flex flex-column" style="padding: 10px 20px;border-radius: 5px;background:#c3e0ff; color:rgb(2, 17, 79); margin-right: 7px;box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
                            ...
                            <a class="text-decoration-none" href="<?php echo e(route('update-employee-details')); ?>">
                                <i class="fa-solid fa-user-plus" style="display:flex;justify-content:center;cursor:pointer;"></i>
                            </a>
                        </div>
                    ...
                    <div class="col-md-6 mb-4 mx-2 bg-white border rounded">
                       <div class="chart-title" >
                        ...
                        <div style="display:flex;justify-content:end;flex-direction:column;align-items:end;">
                           <p style="font-size: 12px;color:#778899;">Male Employees :  <span style="font-size: 12px;color:#000;font-weight:500;"><?php echo e($maleCount); ?></span> </p>
                           <p style="font-size: 12px;color:#778899;">Female Employees :  <span style="font-size: 12px;color:#000;font-weight:500;"><?php echo e($femaleCount); ?></span> </p>
                           <p style="font-size: 12px;color:#778899;">Total Employees :  <span style="font-size: 12px;color:#000;font-weight:500;"><?php echo e($totalEmployeeCount); ?></span> </p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    new Chart(ctx4, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: Object.values(<?php echo json_encode($colors, 15, 512) ?>),
                hoverOffset: 4
            }]
        },
        options: {
...
</div><?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/admin-dashboard.blade.php ENDPATH**/ ?>