    ...
    <div class="container mt-3">
        ...
        <div class="row justify-content-center" style="width: 35%; position: relative; padding-left: 30px;">
            <div class="col-4 text-center" style="border-radius: 5px; cursor: pointer;">
                <a id="starred-tab-link" style="text-decoration: none; font-size: 13px; color: <?php echo e($activeTab === 'starred' ? 'rgb(2, 17, 79);' : 'var(--main-heading-color)'); ?>" wire:click="$set('activeTab', 'starred')" class="links">
                    Starred
                </a>
            </div>
            <div class="col-4 text-center" style="border-radius: 5px; cursor: pointer;">
                <a id="myteam-tab-link" style="text-decoration: none; font-size: 13px; color: <?php echo e($activeTab === 'myteam' ? 'rgb(2, 17, 79);' : 'var(--main-heading-color)'); ?>" wire:click="$set('activeTab', 'myteam')" class="links">
                    My Team
                </a>
            </div>
            <div class="col-4 text-center" style="border-radius: 5px; cursor: pointer;">
                <a id="everyone-tab-link" style="text-decoration: none; font-size: 13px; color: <?php echo e($activeTab === 'everyone' ? 'rgb(2, 17, 79);' : 'var(--main-heading-color)'); ?>" wire:click="$set('activeTab', 'everyone')" class="links">
                    Everyone
                </a>
            </div>
