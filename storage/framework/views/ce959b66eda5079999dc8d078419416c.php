        ...
        <div class="row mt-3 people-all-tabs-container">
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        ...
                        <div class="row">
                            ...
                            <label class="col-6 people-value"><?php echo e(optional($selectStarredPeoples)->contact_details); ?></label>
                        </div>
                        <br>
                        <div class="d-flex align-items-center">
                        ...
                        <div class="row">
                            ...
                            <label class="col-6 people-value"><?php echo e(optional($selectStarredPeoples)->location); ?></label>
                        </div>
                        <br>
                        <div class="d-flex align-items-center">
                        ...
                        <div class="row">
                            ...
                            <label class="col-6 people-value"><?php echo e(optional($selectStarredPeoples)->joining_date ? date('d M, Y', strtotime(optional($selectedPerson)->joining_date)) : ''); ?></label>
                        </div>
                        <div class="row">
                            <label class="col-6 people-label">Date Of Birth</label>
                            <label class="col-6 people-value"><?php echo e(optional($selectStarredPeoples)->date_of_birth ? date('d M, Y', strtotime(optional($selectStarredPeoples)->date_of_birth)) : ''); ?></label>
                        </div>
            ...
            <div class="row people-first-person-container">
                ...
                <div class="col-7">
                    ...
                    <div class="row">
                        <label class="col-6 people-label">Mobile Number</label>
                        <label class="col-6 people-value"><?php echo e(optional($firstStarredPerson)->contact_details); ?></label>
                    </div>
                    <br>
                    <div class="d-flex align-items-center">
                        <span class="people-headings">CATEGORY</span>
                    ...
                    <div class="row">
                        <label class="col-6 people-label">Location</label>
                        <label class="col-6 people-value"><?php echo e(optional($firstStarredPerson)->location); ?></label>
                    </div>
                    <br>
                    <div class="d-flex align-items-center">
                        <span class="people-headings">OTHER INFORMATION</span>
                    ...
                    <div class="row">
                        <label class="col-6 people-label">Joining Date</label>
                        <label class="col-6 people-value"><?php echo e(optional($firstStarredPerson)->joining_date ? date('d M, Y', strtotime(optional($firstStarredPerson)->joining_date)) : ''); ?></label>
                    </div>
                    <div class="row">
                        <label class="col-6 people-label">Date Of Birth</label>
                        <label class="col-6 people-value"><?php echo e(optional($firstStarredPerson)->date_of_birth ? date('d M, Y', strtotime(optional($firstStarredPerson)->date_of_birth)) : ''); ?></label>
                    </div>
    ...
    <div class="col-12 col-md-7 bg-white people-selectedperson-container">
        ...
        <div class="row">
            ...
            <div class="col-7">
                ...
                <div class="row">
                    <label class="col-6 people-label">Mobile Number</label>
                    <label class="col-6 people-value"><?php echo e(optional($selectedPerson)->mobile_number); ?></label>
                </div>
                <br>
                <div class="d-flex align-items-center">
                    <span class="people-headings">CATEGORY</span>
                ...
                <div class="row">
                    <label class="col-6 people-label">Location</label>
                    <label class="col-6 people-value"><?php echo e(optional($selectedPerson)->job_location); ?></label>
                </div>
                <br>
                <div class="d-flex align-items-center">
                    <span class="people-headings">OTHER INFORMATION</span>
                ...
                <div class="row">
                    <label class="col-6 people-label">Joining Date</label>
                    <label class="col-6 people-value"><?php echo e(optional($selectedPerson)->hire_date ? date('d M, Y', strtotime(optional($selectedPerson)->hire_date)) : ''); ?></label>
                </div>
                <div class="row">
                    <label class="col-6 people-label">Date Of Birth</label>
                    <label class="col-6 people-value"><?php echo e(optional($selectedPerson)->date_of_birth ? date('d M, Y', strtotime(optional($selectedPerson)->date_of_birth)) : ''); ?></label>
                </div>
        ...
        <div class="row people-first-person-container">
            ...
            <div class="col-7">
                ...
                <div class="row">
                    <label class="col-6 people-label">Mobile Number</label>
                    <label class="col-6 people-value"><?php echo e(optional($firstPerson)->mobile_number); ?></label>
                </div>
                <br>
                <div class="d-flex align-items-center">
                    <span class="people-headings">CATEGORY</span>
                ...
                <div class="row">
                    <label class="col-6 people-label">Location</label>
                    <label class="col-6 people-value"><?php echo e(optional($firstPerson)->job_location); ?></label>
                </div>
                <br>
                <div class="d-flex align-items-center">
                    <span class="people-headings">OTHER INFORMATION</span>
                ...
                <div class="row">
                    <label class="col-6 people-label">Joining Date</label>
                    <label class="col-6 people-value"><?php echo e(optional($firstPerson)->hire_date ? date('d M, Y', strtotime(optional($firstPerson)->hire_date)) : ''); ?></label>
                </div>
                <div class="row">
                    <label class="col-6 people-label">Date Of Birth</label>
                    <label class="col-6 people-value"><?php echo e(optional($firstPerson)->date_of_birth ? date('d M, Y', strtotime(optional($firstPerson)->date_of_birth)) : ''); ?></label>
                </div>
    ...
    <div class="col-12 col-md-7 bg-white people-selectedperson-container">
        ...
        <div class="row">
            ...
            <div class="col-7">
                ...
                <div class="row">
                    <label class="col-6 people-label">Mobile Number</label>
                    <label class="col-6 people-value"><?php echo e(optional($selectedMyTeamPerson)->mobile_number); ?></label>
                </div>
                <br>
                <div class="d-flex align-items-center">
                    <span class="people-headings">CATEGORY</span>
                ...
                <div class="row">
                    <label class="col-6 people-label">Location</label>
                    <label class="col-6 people-value"><?php echo e(optional($selectedMyTeamPerson)->job_location); ?></label>
                </div>
                <br>
                <div class="d-flex align-items-center">
                    <span class="people-headings">OTHER INFORMATION</span>
                ...
                <div class="row">
                    <label class="col-6 people-label">Joining Date</label>
                    <label class="col-6 people-value"><?php echo e(optional($selectedMyTeamPerson)->hire_date ? date('d M, Y', strtotime(optional($selectedMyTeamPerson)->hire_date)) : ''); ?></label>
                </div>
                <div class="row">
                    <label class="col-6 people-label">Date Of Birth</label>
                    <label class="col-6 people-value"><?php echo e(optional($selectedMyTeamPerson)->date_of_birth ? date('d M, Y', strtotime(optional($selectedMyTeamPerson)->date_of_birth)) : ''); ?></label>
                </div>
