    ...
    <div>
        ...
        <div class="row bg-white ml-2">
            ...
            <div class="col-md-12 bg-white d-flex text-center  " style="height:50px; border-radius:2px;border:1px solid silver">
                ...
                <span class="mt-3 ml-auto">₹<?php echo e(number_format($employee->calculateTotalAllowance()*12, 2)); ?></span>
            </div>
        </div>
                         ...
                         <tr class="table-header" style="color:white;font-weight:normal;font-size:10px;background:rgb(2, 17, 79);height:40px;width:500px;color:white;">
                          ...
                          <tbody class="table-body" style="width:500px;color:black;background:white;font-size:8px;">
                             <tr class="table-row" style="width:500px;">
                                    ...
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->basic*12, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->basic, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->basic, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->basic, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->basic, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->basic, 2)); ?></td>
                                ...
                                <tr class="table-row" style="width:500px;color:black;background:white">
                                    ...
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->hra*12, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->hra, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->hra, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->hra, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->hra, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->hra, 2)); ?></td>
                                ...
                                <tr  class="table-row" style="width:500px;color:black;background:white">
                                    ...
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->conveyance*12, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->conveyance, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->conveyance, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->conveyance, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->conveyance, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->conveyance, 2)); ?></td>
                                ...
                                <tr  class="table-row" style="width:500px;color:black;background:white">
                                    ...
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->medical*12, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->medical, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->medical, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->medical, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->medical, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->medical, 2)); ?></td>
                                ...
                                <tr  class="table-row" style="width:500px;color:black;background:white;">
                                    ...
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->special*12, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->special, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->special, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->special, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->special, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->special, 2)); ?></td>
                                ...
                                <tr  class="table-row" style="width:500px;color:black;background:white;font-size:10px">
                                    ...
                                    <td class="item-value"  style="font-size:11px"><?php echo e(number_format($employee->calculateTotalAllowance()*12, 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->calculateTotalAllowance(), 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->calculateTotalAllowance(), 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->calculateTotalAllowance(), 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->calculateTotalAllowance(), 2)); ?></td>
                                    <td class="item-value" style="font-size:11px"><?php echo e(number_format($employee->calculateTotalAllowance(), 2)); ?></td>
        ...
        <div class="row bg-white ml-2 mt-3">
           ...
           <div class="col-md-12 bg-white d-flex text-center  " style="height:50px; border-radius:2px;border:1px solid silver;">
              ...
              <span class="mt-3 ml-auto">₹<?php echo e(number_format($employee->calculatePf() * 12 + 1800, 2)); ?></span>
          </div>
       </div>
                  ...
                  <table class="income-table " style="width:500px;">
                       ...
                       <tbody class="table-body" style="width:500px;color:black;background:white">
                            <tr class="table-row">
                                ...
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf()*12, 2)); ?></td>
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf(), 2)); ?></td>
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf(), 2)); ?></td> 
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf(), 2)); ?></td>
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf(), 2)); ?></td>
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf(), 2)); ?></td>
                            ...
                            <tr class="table-row" style="width:500px;color:black;background:white">
                                ...
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf()+150*12, 2)); ?></td>
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf() + 150, 2)); ?></td>
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf() + 150, 2)); ?></td>
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf() + 150, 2)); ?></td>
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf() + 150, 2)); ?></td>
                                <td class="item-value"><?php echo e(number_format($employee->calculatePf() + 150, 2)); ?></td>
       ...
       <div class="col-md-12 bg-white d-flex text-center mt-3 ml-1" style="height:50px; border-radius:2px;border:1px solid silver">
        ...
        <div class="col-md-12 mt-4 m-l-2 d-flex" style="height:40px; border-radius:2px;border:1px solid silver;background:rgb(2, 17, 79);color:white">
            ...
            <span class="ml-auto pt-2">₹<?php echo e(number_format($employee->calculateTotalAllowance() * 12, 2)); ?></span>
        </div>
...
<?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/itstatement1.blade.php ENDPATH**/ ?>