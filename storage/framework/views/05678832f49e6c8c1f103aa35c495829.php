        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="max-width: 200px;font-weight:400; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                        <?php echo e(ucwords(strtolower($emp->first_name))); ?>&nbsp;<?php echo e(ucwords(strtolower($emp->last_name))); ?><span class="text-muted">(#<?php echo e($emp->emp_id); ?>)</span><br /><span class="text-muted" style="font-size:11px;"><?php echo e(ucfirst($emp->job_role)); ?>,<?php echo e(ucfirst($emp->job_location)); ?></span>
                    </td>
                    <?php
                    $found = false;
