...
<!--[if BLOCK]><![endif]--><?php if($currentCardEmojis && $emojisCount > 0): ?>
  ...
  <!--[if BLOCK]><![endif]--><?php if($currentCardComments && $currentCardComments->count() > 0): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($comment->employee->personalInfo && $comment->employee->personalInfo->image): ?>
        <img style="border-radius: 50%;" height="25" width="25" src="<?php echo e(asset('storage/' . $comment->employee->personalInfo->image)); ?>">
    <?php else: ?>
    <!--[if BLOCK]><![endif]--><?php if($comment->employee->personalInfo && $comment->employee->personalInfo->gender == "Male"): ?>
        ...
        <?php elseif($comment->employee->personalInfo && $comment->employee->personalInfo->gender == "Female"): ?>
