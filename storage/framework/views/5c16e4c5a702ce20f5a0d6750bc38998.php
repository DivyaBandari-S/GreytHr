<div>
    ...
    ?>
    <!--[if BLOCK]><![endif]--><?php for($i = 1; $i <= $daysInMonth; $i++): ?> <?php $timestamp=mktime(0, 0, 0, $currentMonth, $i, $currentYear); $dayName=date('D', $timestamp); $fullDate=date('Y-m-d', $timestamp); ?> <?php endfor; ?><!--[if ENDBLOCK]><![endif]--> <div class="row m-0">
        <div class="col-md-8">
...
<div class="m-0 mt-5 row" style="margin-top: 20px;">
    <div class="summary col-md-3">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <!--[if BLOCK]><![endif]--><?php if(($Employees)): ?>
                <tr>
                    <td style="max-width: 200px;font-weight:400; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                        <?php echo e(ucwords(strtolower($emp->first_name))); ?>&nbsp;<?php echo e(ucwords(strtolower($emp->last_name))); ?><span class="text-muted">(#<?php echo e($emp->emp_id); ?>)</span><br /><span class="text-muted" style="font-size:11px;"><?php echo e(ucwords(strtolower($emp->job_title))); ?>,<?php echo e(ucwords(strtolower($emp->city))); ?>,<?php echo e(ucwords(strtolower($emp->state))); ?></span>
                    </td>
                    ...
                    $dateCount=0;
                    ?>
                    <!--[if BLOCK]><![endif]--><?php for($i = 1; $i <= $daysInMonth; $i++): ?> <?php $timestamp=mktime(0, 0, 0, $currentMonth, $i, $currentYear); $dayName=date('D', $timestamp); // Get the abbreviated day name (e.g., Sun, Mon) $fullDate=date('Y-m-d', $timestamp); // Full date in 'YYYY-MM-DD' format ?> <!--[if BLOCK]><![endif]--><?php if($dayName==='Sat' || $dayName==='Sun' ): ?> <?php $dateCount+=1; ?> <?php endif; ?><!--[if ENDBLOCK]><![endif]--> <?php endfor; ?><!--[if ENDBLOCK]><![endif]--> <?php $noofregulardays=$daysInMonth-$dateCount-$CountOfHoliday ?> <td><?php echo e($noofregulardays); ?></td>
    ...
    <div class="Attendance col-md-9">
        ...
        <p style="background:#ebf5ff; padding:5px 15px;font-size:0.755rem;">Shift Days for <?php echo e(date("M", mktime(0, 0, 0, $currentMonth, 1))); ?> ,<?php echo e($currentYear); ?></p>
                ...
                <tr style="background-color:#fff;">
                    ...
                    <!--[if BLOCK]><![endif]--><?php for($i = 1; $i <= $daysInMonth; $i++): ?> 
                        <?php 
                           ...
                           $fullDate=date('Y-m-d', $timestamp); // Full date in 'YYYY-MM-DD' format 
                        ?> 
                        <td style="background-color: <?php echo e(in_array($dayName, ['Sat', 'Sun']) ? '#f2f2f2' : '#fff'); ?>;">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($h->date==$fullDate): ?>
                        ...
                        <?php else: ?>
                         ...
                         <p style="font-weight:bold;padding-top:15px;"><?php echo e($emp->shift_type); ?></p>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
</div><?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/shift-roaster.blade.php ENDPATH**/ ?>