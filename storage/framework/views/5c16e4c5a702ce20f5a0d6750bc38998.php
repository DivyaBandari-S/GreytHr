            ...
            <tbody>
                ...
                <tr>
                    <td style="max-width: 200px;font-weight:400; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                        <?php echo e(ucwords(strtolower($emp->first_name))); ?>&nbsp;<?php echo e(ucwords(strtolower($emp->last_name))); ?><span class="text-muted">(#<?php echo e($emp->emp_id); ?>)</span><br /><span class="text-muted" style="font-size:11px;"><?php echo e(ucwords(strtolower($emp->job_role))); ?>,<?php echo e(ucwords(strtolower($emp->job_location))); ?></span>
                    </td>
                ...
                <?php endfor; ?><!--[if ENDBLOCK]><![endif]--> 
                    ...
                    ?> 
                    <td><?php echo e($noofregulardays); ?></td>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr style="background-color:#fff;">
                   <!--[if BLOCK]><![endif]--><?php if(!empty($emp->shift_type)): ?>
                        <!--[if BLOCK]><![endif]--><?php for($i = 1; $i <= $daysInMonth; $i++): ?>
