        ...
        <table class="swipes-table mt-2 border" style="width: 100%;">
            ...
            <tr style="border:1px solid #ccc;">
                ...
                <td style="width:50%;font-size: 10px; color: <?php echo ($emp->employee_status == 'active') ? '#778899' : '#f66'; ?>;text-align:start;padding:5px 10px;white-space:nowrap;">
                    <input type="checkbox" name="employeeCheckbox[]" class="employee-swipes-checkbox" wire:model="shiftSummary"  value="<?php echo e($emp->emp_id); ?>">
...
</div><?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/shift-summary-report.blade.php ENDPATH**/ ?>