<div class=" m-0 p-0">
  ...
  $onLeave=0;
  ?>
  <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $Swipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <?php
  $swipeTime = \Carbon\Carbon::parse($s1->swipe_time);
  $isLateBy10AM = $swipeTime->format('H:i') > $s1->shift_start_time;
  $isEarlyBy10AM= $swipeTime->format('H:i') <= $s1->shift_start_time ; ?> <!--[if BLOCK]><![endif]--><?php if($isLateBy10AM): ?> <?php $notyetin++; $lateArrival++; ?> <?php endif; ?><!--[if ENDBLOCK]><![endif]--> <!--[if BLOCK]><![endif]--><?php if($isEarlyBy10AM): ?> <?php $onTime++; ?> <?php endif; ?><!--[if ENDBLOCK]><![endif]--> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]--> <?php $CalculatePresentOnTime=($EarlySwipesCount/$TotalEmployees)*100; $CalculatePresentButLate=($LateSwipesCount/$TotalEmployees)*100; ?> <div class="date-form-who-is-in">
...
<!--[if BLOCK]><![endif]--><?php if($openshiftselector==true): ?>
      ...
      <div class="modal-body" style="max-height:300px;overflow-y:auto">
        <div class="toggle-box-container-who-is-in">
          <span style="margin-right: 10px;margin-top:-5px;font-size:12px;color:#778899">
            <!--[if BLOCK]><![endif]--><?php if($isToggled): ?>
            Active(1)
            <?php else: ?>
            All(1)
          ...
          <label class="switch-who-is-in">
            <input type="checkbox" wire:click="toggle" <?php echo e($isToggled ? 'checked' : ''); ?>>
        ...
        <div class="wide-short-container-who-is-in">
          <div style="display:flex;align-items:center;justify-content:space-between">
            ...
            <span class="total-employee-count-who-is-in"><?php echo e($dayShiftEmployeesCount); ?> employee(s)</span>
          </div>
        ...
        <div class="wide-short-container-who-is-in">
          <div style="display:flex;align-items:center;justify-content:space-between">
            ...
            <span class="total-employee-count-who-is-in"><?php echo e($afternoonShiftEmployeesCount); ?> employee(s)</span>
          </div>
          <div class="time-range-who-is-in">
        ...
        <div class="wide-short-container-who-is-in">
          <div style="display:flex;align-items:center;justify-content:space-between">
            ...
            <span class="total-employee-count-who-is-in"><?php echo e($eveningShiftEmployeesCount); ?> employee(s)</span>
          </div>
          <div class="time-range-who-is-in">
...
<div cs="mx-1 p-0">
  <div class="container-box-for-employee-information-who-is-in">
    ...
    <div style="margin-top:5px;display:flex;align-items:center; text-align:center;justify-content:center;padding:0;">
      <p style="text-align:center;font-size:14px;">Employees Information for <span style="font-weight: 500; "><?php echo e(\Carbon\Carbon::parse($currentDate)->format('jS F Y')); ?></span></p>
    </div>
    ...
    <div class="content" style="display:flex; flex-direction:row;justify-content:space-between;padding:0; border-top:1px solid #52afe9;">
      <div class="col-md-3 field-for-employee-who-is-in">
        <div class="percentage-who-is-in" style="font-weight: 500;font-size:14px;"><?php echo e(number_format($CalculateAbsentees,2)); ?>%</div>

        <!--[if BLOCK]><![endif]--><?php if($employeesCount1>0): ?>
        <div class="employee-count-who-is-in"><?php echo e($employeesCount1); ?>&nbsp;Employee(s)&nbsp;are&nbsp;Absent</div>
        <?php else: ?>
        <div class="employee-count-who-is-in">No&nbsp;Employee(s)&nbsp;are&nbsp;Absent</div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
      </div>
      <div class="col-md-3 field-for-employee-who-is-in">
        <div class="percentage-who-is-in" style="font-weight: 500;font-size:14px;"><?php echo e(number_format($CalculatePresentButLate,2)); ?>%</div>
        <!--[if BLOCK]><![endif]--><?php if($LateSwipesCount>0): ?>
        <div class="employee-count-who-is-in"><?php echo e($LateSwipesCount); ?>&nbsp;Employee(s)&nbsp;are&nbsp;Late&nbsp;In</div>
        <?php else: ?>
        <div class="employee-count-who-is-in">No&nbsp;Employee(s)&nbsp;are&nbsp;Late&nbsp;In</div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
      </div>
      <div class="col-md-3 field-for-employee-who-is-in">
        <div class="percentage-who-is-in" style="font-weight: 500;font-size:14px;"><?php echo e(number_format($CalculatePresentOnTime,2)); ?>%</div>
        <!--[if BLOCK]><![endif]--><?php if($EarlySwipesCount>0): ?>
        <div class="employee-count-who-is-in"><?php echo e($EarlySwipesCount); ?>&nbsp;Employee(s)&nbsp;are&nbsp;On&nbsp;Time</div>
        <?php else: ?>
      ...
      <div class="col-md-3 field-for-employee-who-is-in">
        <div class="percentage-who-is-in" style="font-weight: 500;font-size:14px;"><?php echo e(number_format($CalculateApprovedLeaves,2)); ?>%</div>

        <!--[if BLOCK]><![endif]--><?php if($ApprovedLeaveRequestsCount>0): ?>
        <div class="employee-count-who-is-in"><?php echo e($ApprovedLeaveRequestsCount); ?>&nbsp;Employee(s)&nbsp;are&nbsp;On&nbsp;Leave</div>
        <?php else: ?>
...
<div class="row m-0 p-0" style=" display:flex;">
  ...
  <div class="col-md-3">
    <div class="container5-who-is-in">
      <div class="heading-who-is-in">
        <h3>Absent&nbsp;(<?php echo e(str_pad($employeesCount1, 2, '0', STR_PAD_LEFT)); ?>)</h3>
      ...
      <div>
        <table class="who-is-in-table" style="margin-top:-10px">
          ...
          <tbody>
            ...
            <?php else: ?>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $Employees1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr style="border-bottom: 1px solid #ddd;">
              <td style="font-size:10px;font-weight:700;max-width:120px;overflow: hidden;white-space: nowrap; text-overflow: ellipsis;">
                <?php echo e(ucwords(strtolower($e1->first_name))); ?> <?php echo e(ucwords(strtolower($e1->last_name))); ?><br />
                <span class="text-muted" style="font-weight:normal;font-size:10px;">#<?php echo e($e1->emp_id); ?></span>
              </td>
              <td style="font-weight:700;font-size:10px;"><?php echo e($e1->shift_start_time); ?></td>
            </tr>
  ...
  <div class="col-md-3">
    <div class="container5-who-is-in">
      <div class="heading-who-is-in">
        <h3>Late&nbsp;Arrivals&nbsp;(<?php echo e(str_pad($lateArrival, 2, '0', STR_PAD_LEFT)); ?>)</h3>
      ...
      <div>
        <table class="who-is-in-table" style="margin-top:-10px">
          <!--[if BLOCK]><![endif]--><?php if($lateArrival > 0): ?>
          <thead>
            <tr>
              <th>Employee</th>
              <th>Late&nbsp;By</th>
          ...
          <tbody>
            ...
            <!--[if BLOCK]><![endif]--><?php if($isLateBy10AM): ?>
            ...
            <tr style="border-bottom: 1px solid #ddd;">
              <td style="font-size:10px;font-weight:700;max-width:110px;overflow: hidden;white-space: nowrap; text-overflow: ellipsis;padding-left:15px;">
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $firstNameParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e(ucfirst(strtolower($part))); ?>

                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->

                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $lastNameParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e(ucfirst(strtolower($part))); ?>

                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->

                <br /><span class="text-muted" style="font-weight:normal;font-size:10px;">#<?php echo e($s1->emp_id); ?></span>
              </td>
              <td style="font-weight:700;font-size:10px;padding-left:12px;"><?php echo e($lateArrivalTime); ?><br /><span class="text-muted" style="font-size:10px;font-weight:300;"><?php echo e($s1->swipe_time); ?></span></td>
            </tr>
  ...
  <div class="col-md-3">
    <div class="container5-who-is-in" style="margin-left:-20px;">
      <div class="heading-who-is-in">
        <h3>On&nbsp;Time&nbsp;(<?php echo e(str_pad($onTime, 2, '0', STR_PAD_LEFT)); ?>)</h3>
      ...
      <div>
        <table class="who-is-in-table" style="margin-top:-10px">
          <!--[if BLOCK]><![endif]--><?php if($onTime > 0): ?>
  ...
  <div class="col-md-3">
    <div class="container5-who-is-in" style="margin-left:-20px;">
      <div class="heading-who-is-in">
        <h3>On&nbsp;Leave&nbsp;(<?php echo e(str_pad($ApprovedLeaveRequestsCount, 2, '0', STR_PAD_LEFT)); ?>)</h3>
      ...
      <div>
        <table class="who-is-in-table" style="margin-top:-10px">
          ...
          <tbody>
            <!--[if BLOCK]><![endif]--><?php if($notFound3): ?>
            <tr>
              <td colspan="2" style="text-align: center;">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQi7kQkKftvg3JCfA63d_BWJbSNrTwsX9QQPRUS7Okm5iTciCkig3wOxRUQB59BO6AM0Ng&usqp=CAU" style="width: 30px;">
            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $ApprovedLeaveRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr style="border-bottom: 1px solid #ddd;">
              <td style="font-size:10px;font-weight:700;overflow: hidden; text-overflow: ellipsis; white-space: nowrap;max-width:100px;">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                <br /><span class="text-muted" style="font-weight:normal;font-size:10px;">#<?php echo e($alr->emp_id); ?></span>
              </td>
              <td style="font-weight:700;font-size:10px;"><?php echo e($alr->number_of_days); ?> Day(s)<br />
...
</div><?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/who-is-in-chart.blade.php ENDPATH**/ ?>