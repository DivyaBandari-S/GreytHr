<div>
    ...
    <div class="container" style="margin-top:15px;width:100%; height: 600px; border: 1px solid silver; border-radius: 5px;background-color:white; overflow: hidden;">
        ...
        <div class="nav-buttons d-flex justify-content-center" style="margin-top: 15px;">
            <ul class="nav custom-nav-tabs border">
                <li class="custom-item m-0 p-0 flex-grow-1">
                    <a href="#" style="border-top-left-radius:5px;border-bottom-left-radius:5px;" class="custom-nav-link <?php echo e($activeTab === 'open' ? 'active' : ''); ?>" wire:click.prevent="setActiveTab('open')">Open</a>
                </li>
                <li class="custom-item m-0 p-0 flex-grow-1">
                    <a href="#" style="border-top-right-radius:5px;border-bottom-right-radius:5px;" class="custom-nav-link <?php echo e($activeTab === 'completed' ? 'active' : ''); ?>" wire:click.prevent="setActiveTab('completed')">Closed</a>
                </li>
            </ul>
        </div>
        ...
        <div style="display:flex; justify-content:flex-end;">
            <button wire:click="show" style="background-color:rgb(2, 17, 79); border: none; border-radius: 5px; color: white; font-size: 0.75rem; height: 30px; cursor: pointer; margin-top: 15px; margin-right: 20px;width:100px;">Add
                New Task</button>
        </div>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr style="background-color: rgb(2, 17, 79); color: white;">
                            <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 7%">
                                <i class="fa fa-angle-down" style="color: white; padding-left: 8px;"></i>
                            </th>
                            <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 12%">Assignee</th>
                            <th style="padding: 8px; font-size: 0.75rem; text-align: center; width: 13%">Followers</th>
                            <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 12%">Assigned By
                            </th>
                            <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 10%">Task Name</th>
                            <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 12%">Due Date</th>
                            <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 12%">Assigned Date
                            </th>
                            <th style="padding: 8px; font-size: 0.75rem; text-align: center; width: 22%">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="padding: 10px; border:none; font-size: 0.75rem; text-align: <?php echo e($record->followers ? 'start' : 'center'); ?>; width: 13%">
                                <?php echo e(ucfirst($record->followers) ?: '-'); ?>

                            </td>
                            <td style="padding: 10px; border:none; font-size: 0.75rem; text-align: start; width: 12%">
                                <?php echo e(ucwords(strtolower($record->emp->first_name))); ?> <?php echo e(ucwords(strtolower($record->emp->last_name))); ?>
                            ...
                            <td style="padding: 10px; border:none; font-size: 0.75rem; text-align: center; width: 22%">
                                ...
                                <button type="button" wire:click.prevent="openAddCommentModal('<?php echo e($record->id); ?>')" class="submit-btn" data-toggle="modal" data-target="#exampleModalCenter">Comment</button>
                                <button wire:click="openForTasks('<?php echo e($record->id); ?>')" style="border:1px solid rgb(2, 17, 79);width:80px; padding: 5px 0.75rem;" class="cancel-btn">Close</button>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="8" class="m-0 p-0" style="background-color: #fff; padding: 0; margin: 0;">
                                    ...
                                    <table class="rounded border" style="margin-top: 20px; width: 100%; border-collapse: collapse;">
                                        <thead class="py-0" style="background-color: #ecf9ff; box-shadow: 1px 0px 2px 0px rgba(0, 0, 0, 0.2); border-bottom: 1px solid #ccc; padding: 5px;">
                                            <tr style="color: #778899;">
                                                <th style="font-weight: 500; width: 22%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                    Priority</th>
                                                <th style="font-weight: 500; width: 18%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                    Due Date</th>
                                                <th style="font-weight: 500; width: 18%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                    Subject</th>
                                                <th style="font-weight: 500; width: 15%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                    Description</th>
                                                <th style="font-weight: 500; width: 38%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                    Attach</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td style="border: none; width: 22%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                    <?php echo e($record->priority); ?>

                                                </td>
                                                <td style="border: none; width: 18%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                    <?php echo e(\Carbon\Carbon::parse($record->due_date)->format('d M, Y')); ?>
                                                ...
                                                <td style="border: none; width: 15%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                    <?php echo e(ucfirst($record->description ?? '-')); ?>

                                                </td>
                                                <td style="border: none; width: 38%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                    <!--[if BLOCK]><![endif]--><?php if($record->file_path): ?>
                                                    <a href="<?php echo e(asset('storage/' . $record->file_path)); ?>" target="_blank" style="text-decoration: none; color: #007BFF;">View File</a>
                                                    <?php else: ?>
                                                    N/A
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                </td>
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <thead>
                            <tr style="background-color: rgb(2, 17, 79); color: white;">
                                ...
                                <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 10%">Assignee
                                </th>
                                <th style="padding: 8px; font-size: 0.75rem; text-align: center; width: 10%">Followers
                                </th>
                                <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 10%">Assigned By
                                </th>
                                <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 10%">Task Name
                                </th>
                                <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 10%">Due Date
                                </th>
                                <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 10%">Assigned
                                    Date</th>
                                <th style="padding: 8px; font-size: 0.75rem; text-align: start; width: 10%">Closed
                                    Date</th>
                                <th style="padding: 8px; font-size: 0.75rem; text-align: center; width: 23%">Actions
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding: 10px; border:none; font-size: 0.75rem; text-align: <?php echo e($record->followers ? 'start' : 'center'); ?>; width: 10%">
                                    <?php echo e(ucfirst($record->followers) ?: '-'); ?>
                                ...
                                <td style="padding: 10px; border:none; font-size: 0.75rem; text-align: start; width: 10%; color: <?php echo e(\Carbon\Carbon::parse($record->updated_at)->startOfDay()->gt(\Carbon\Carbon::parse($record->due_date)->startOfDay()) ? 'red' : 'inherit'); ?>;">
                                    <?php echo e(\Carbon\Carbon::parse($record->due_date)->format('d M, Y')); ?>
                                ...
                                <td style="padding: 10px; border:none; font-size: 0.75rem; text-align: center; width: 23%">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $record->comments ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo e($comment->comment); ?>
                                    ...
                                    <!-- Add Comment link to trigger modal -->
                                    <button type="button" wire:click.prevent="openAddCommentModal('<?php echo e($record->id); ?>')" class="submit-btn" data-toggle="modal" data-target="#exampleModalCenter">Comment</button>
                                    <button wire:click="closeForTasks('<?php echo e($record->id); ?>')" style="border:1px solid rgb(2,17,79); width: 80px;  padding: 5px 0.75rem;" class="cancel-btn1">Reopen</button>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="9" class="m-0 p-0" style="background-color: #fff; padding: 0; margin: 0;">
                                    <div class="accordion-content mt-0" style="display: none; padding: 0 10px;margin-bottom:20px;">
                                        <!-- Content for accordion body -->
                                        <table class="rounded border" style="margin-top: 20px; width: 100%; border-collapse: collapse;">
                                            <thead class="py-0" style="background-color: #ecf9ff; box-shadow: 1px 0px 2px 0px rgba(0, 0, 0, 0.2); border-bottom: 1px solid #ccc; padding: 5px;">
                                                <tr style="color: #778899;">
                                                    <th style="font-weight: 500; width: 20%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                        Priority</th>
                                                    <th style="font-weight: 500; width: 20%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                        Due Date</th>
                                                    <th style="font-weight: 500; width: 20%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="border: none; width: 20%; padding: 10px; font-size: 0.75rem; text-align: center;">
                                                        <?php echo e($record->priority); ?>
                        ...
                        <div class="modal-body">
                            <div class="task-container">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="text" wire:model.debounce.0ms="task_name" wire:input="autoValidate" class="placeholder-small" placeholder="Enter task name" style="width: 100%;font-size:0.75rem;padding:5px;outline:none;border:1px solid #ccc;border-radius:5px;">
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['task_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">Task name is required</span> <?php unset($message);
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">Assignee is required</span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                                <!--[if BLOCK]><![endif]--><?php if($assigneeList): ?>
                                <div style="border-radius:5px;background-color:grey;padding:8px;width:350px;max-height:250px;overflow-y:auto; ">
                                    ...
                                    <div class="container" style="text-align: center; color: white; font-size: 0.75rem;">No People Found
                                    </div>
                                    <?php else: ?>
                                    ...
                                    <div wire:click="selectPerson('<?php echo e($people->emp_id); ?>')" class="container" style="cursor: pointer; background-color: darkgrey; padding: 5px; margin-bottom: 8px; width: 300px; border-radius: 5px;">
                                        <div class="row align-items-center">
                                            <label for="person-<?php echo e($people->emp_id); ?>" style="width: 100%; display: flex; align-items: center; margin: 0;">
                                                <div class="col-auto">
                                                    <input type="radio" id="person-<?php echo e($people->emp_id); ?>" wire:change="autoValidate" wire:model="assignee" value="<?php echo e($people->emp_id); ?>">
                                                </div>
                                                <div class="col-auto">
                                                    <img class="profile-image" src="<?php echo e(!is_null($people->image) && filter_var($people->image, FILTER_VALIDATE_URL) ? $people->image :
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div style="margin-bottom: 10px;">
                                            <label style="font-size: 13px;color:#778899" for="clientSelect">Select
                                                Client*</label>
                                            <select wire:change="showProjects" style="width: 100%;font-size:0.75rem;padding:5px;outline:none;border:1px solid #ccc;border-radius:5px;" id="clientSelect" wire:model="client_id">
                                                ...
                                                <option style="color:#778899;" value="<?php echo e($client->client->client_id); ?>">
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">Client ID is required</span>
                                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div style="margin-bottom: 10px;">
                                            <label style="font-size: 13px;color:#778899" for="clientSelect">Select
                                                Project*</label>
                                            <select wire:change="autoValidate" style="width: 100%;font-size:0.75rem;padding:5px;outline:none;border:1px solid #ccc;border-radius:5px;" id="clientSelect" wire:model="project_name">
                                                ...
                                                <option style="color:#778899;" value="<?php echo e($project->project_name); ?>">
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">Project name is
                                                required</span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div class="col-md-8 mt-1">
                                            <div id="priority" style="display: flex; align-items: center; margin-top: 0px;">
                                                <div class="priority-option" style="margin-left: 0px; padding: 0;">
                                                    ...
                                                    <span style="font-size: 0.75rem;color:#778899; padding: 0;margin-left:5px" class="text-xs">Low</span>
                                                </div>
                                                <div class="priority-option" style="margin-left: 20px; padding: 0;">
                                                    ...
                                                    <span style="font-size: 0.75rem;color:#778899; padding: 0;margin-left:5px" class="text-xs">Medium</span>
                                                </div>
                                                <div class="priority-option" style="margin-left: 20px; padding: 0;">
                                                    <input type="radio" id="high-priority" name="priority" wire:change="autoValidate" wire:model="priority" value="High">
                                                    <span style="font-size: 0.75rem;color:#778899; padding: 0;margin-left:5px" class="text-xs">High</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">Priority is
                                    required</span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="row" style="margin-top: 10px;">
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="form-label" style="font-size: 13px;color:#778899; margin-left: 0px; margin-top: 0px; padding: 0 10px 0 0;">Due
                                                Date*</label>
                                            <br>
                                            <input wire:change="autoValidate" type="date" wire:model="due_date" class="placeholder-small" style="width: 100%;font-size:0.75rem;padding:5px;outline:none;border:1px solid #ccc;border-radius:5px;" min="<?= date('Y-m-d'); ?>" value="<?= date('Y-m-d'); ?>">
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['due_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger">Due date is required</span>
                                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div style="border-radius:5px;background-color:grey;padding:8px;width:350px;max-height:250px;overflow-y:auto;">
                                    ...
                                    <?php else: ?>
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $peopleData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $people): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div wire:model="cc_to" wire:click="selectPersonForFollowers('<?php echo e($people->emp_id); ?>')" class="container" style="cursor: pointer; background-color: darkgrey; padding: 5px; margin-bottom: 8px; width: 300px; border-radius: 5px;">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <input type="checkbox" wire:model="selectedPeopleForFollowers" value="<?php echo e($people->emp_id); ?>">
                                            </div>
                                            <div class="col-auto">
                                                <img class="profile-image" src="<?php echo e(!is_null($people->image) && filter_var($people->image, FILTER_VALIDATE_URL) ? $people->image :
                                                            (!empty($people->image) ? Storage::url($people->image) :
                                ...
                                <input wire:change="autoValidate" style="font-size: 0.75rem;" wire:model="image" type="file" accept="image/*" onchange="handleImageChange()">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <!-- <div class="alert alert-success d-flex justify-content-between align-items-center" role="alert">
                                <span><?php echo e(session('comment_message')); ?></span>
                                ...
                                <div class="comment mb-4 mt-2">
                                    <div class="d-flex align-items-center gap-5">
                                        <div class="col-md-4 p-0 comment-details">
                                            <p style="color: #000;font-size:0.75rem;font-weight:500;margin-bottom:0;" class="truncate-text" title="<?php echo e($comment->employee->full_name); ?>">
                                                <?php echo e($comment->employee->full_name); ?>

                                            </p>
                                        </div>
                                        <div class=" col-md-3 p-0 comment-time">
                                            <span style="color: #778899;font-size:10px;font-weight:normal;margin-left:15px;"><?php echo e($comment->created_at->diffForHumans()); ?></span>
                                        </div>
                                        <!-- <div class=" col-md-2 p-0 comment-actions">
                                                <button class="comment-btn" wire:click="openEditCommentModal(<?php echo e($comment->id); ?>)"> <i class="fas fa-edit" style="color: #778899;height:7px;width:7px;"></i></button>
                                                <button class="comment-btn" wire:click="deleteComment(<?php echo e($comment->id); ?>)"><i class="fas fa-trash" style="color: #778899;height:7px;width:7px;"></i></button>
                                            </div> -->
                                        <!--[if BLOCK]><![endif]--><?php if(Auth::guard('emp')->user()->emp_id == $comment->emp_id): ?>
                                        <div class="col-md-2 p-0 comment-actions">
                                            <button class="comment-btn" wire:click="openEditCommentModal(<?php echo e($comment->id); ?>)">
                                                <i class="fas fa-edit" style="color: #778899;height:7px;width:7px;"></i>
                                            </button>
                                            <button class="comment-btn" wire:click="deleteComment(<?php echo e($comment->id); ?>)">
                                    ...
                                    <div class="col p-0 comment-content">
                                        ...
                                        <button class="update-btn p-1" wire:click="updateComment(<?php echo e($comment->id); ?>)">Update</button>
