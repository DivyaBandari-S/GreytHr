<div>
    ...
    <div class="button-container">
        <button class="my-button apply-button" style="background-color: <?php echo e(($isApply == 1 && $defaultApply == 1) ? 'rgb(2,17,79)' : '#fff'); ?>;color: <?php echo e(($isApply == 1 && $defaultApply == 1) ? '#fff' : 'initial'); ?>;" wire:click="applyButton">Apply</button>
        <button class="my-button pending-button" style="background-color: <?php echo e(($isPending==1&&$defaultApply==0) ? 'rgb(2,17,79)' : '#fff'); ?>;color: <?php echo e(($isPending==1&&$defaultApply==0) ? '#fff' : 'initial'); ?>;" wire:click="pendingButton">Pending</button>
        <button class="my-button history-button" style="background-color: <?php echo e(($isHistory==1&&$defaultApply==0) ? 'rgb(2,17,79)' : '#fff'); ?>;color: <?php echo e(($isHistory==1&&$defaultApply==0) ? '#fff' : 'initial'); ?>;" wire:click="historyButton">History</button>
    </div>
    <!--[if BLOCK]><![endif]--><?php if($isApply==1&&$defaultApply==1): ?>
    <div class="h row m-0 mt-4">
            ...
            <div class="calendar-box">
                <div class="calendar-header">
                    ...
                    <p style="margin-top:7px; font-weight: 600">
                        ...
                        <?php echo e(\Carbon\Carbon::createFromDate($this->year, $this->month, 1)->format('F Y')); ?>
                ...
                <div class="calendar-dates">
                    ...
                    <div class="calendar-week">
                        ...
                        <div class="calendar-date <?php echo e($day['isCurrentDate'] ? 'current-date' : ''); ?> <?php echo e(in_array($day['date'], $selectedDates) ? 'selected-date' : ''); ?><?php echo e($day['isCurrentMonth'] ? '' : 'other-month-date'); ?><?php echo e($day['isAfterToday'] ? 'after-today' : ''); ?>" wire:click="selectDate('<?php echo e($day['date']); ?>')"><?php echo e($day['day']); ?></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                <div class="calendar-footer" style="text-align: center;
                                <?php if($isdatesApplied): ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($isdatesApplied==true): ?>
        ...
        <div class="col-md-7 mb-3">
            <!--[if BLOCK]><![endif]--><?php if(count($selectedDates)>0): ?>
            <div class="remarks-container">
                <input type="text" placeholder="Enter Remarks" wire:model="remarks">
            </div>
            <div class="col-md-5">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $regularisationEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $regularisationEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="container1" style="background-color:white;">
                    <div class="row m-0">
                        <div class="col-2 pb-1 pt-1 p-0" style="border-right: 1px solid black; text-align: center;">
                            <p class="mb-1" style="font-weight:bold;font-size:20px;">
                                <?php echo e(date('d', strtotime($regularisationEntry['date']))); ?>
                    ...
                    <button type="button" class="btn btn-cross" style="position: absolute; top: 20px; right: -340px;">
                        <i class="fas fa-times" wire:click="deleteStoredArray(<?php echo e($index); ?>)"></i>
                    </button>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" style="width:20%" wire:model="regularisationEntries.<?php echo e($index); ?>.from" required><br>
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ["regularisationEntries.$index.from"];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <td>
                                        ...
                                        <input type="text" style="width:20%" wire:model="regularisationEntries.<?php echo e($index); ?>.to" required><br>
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ["regularisationEntries.$index.to"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="error"><?php echo e($message); ?></span>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <td>
                                        ...
                                        <input type="text" style="width:75%" wire:model="regularisationEntries.<?php echo e($index); ?>.reason" required><br>
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ["regularisationEntries.$index.reason"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <?php else: ?>
        <div class="apply-box">
            <img src="<?php echo e(asset('images/pending.png')); ?>" style="margin-top:50px;" height="180" width="180">
...
<?php elseif($isPending==1&&$defaultApply==0): ?>
<!--[if BLOCK]><![endif]--><?php if(count($pendingRegularisations)>0): ?>
<!--[if BLOCK]><![endif]--><?php $__currentLoopData = $pendingRegularisations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<!--[if BLOCK]><![endif]--><?php if($pr->regularisation_entries!='[]'): ?>
<?php
...
<div class="accordion-heading rounded" onclick="toggleAccordion(this)" style="margin-top:10px;">
    ...
    <div class="accordion-title p-2 rounded">
        ...
        <div class="col accordion-content">
            ...
            <!--[if BLOCK]><![endif]--><?php if(!empty($EmployeeDetails)): ?>
            <span style="color: #36454F; font-size: 12px; font-weight: 500;"><?php echo e(ucwords(strtolower($EmployeeDetails->first_name))); ?>&nbsp;<?php echo e(ucwords(strtolower($EmployeeDetails->last_name))); ?></span>
            <?php else: ?>
        ...
        <div class="col accordion-content">
            ...
            <span style="margin-top:0.625rem; font-size: 12px; font-weight: 400; color:#cf9b17;text-transform:uppercase;"><?php echo e($pr->status); ?></span>
...
<div class="accordion-body m-0 p-0">
    ...
    <div class="content px-2">
        ...
        <span style="font-size: 11px;">
            ...
            <span style="font-size: 11px; font-weight: 500;">
                <?php echo e(date('d', strtotime($lastItem['date']))); ?>

                <?php echo e(date('M Y', strtotime($lastItem['date']))); ?>
    ...
    <div style="display:flex; flex-direction:row; justify-content:space-between;">
        ...
        <div class="content px-2">
            ...
            <span style="color: #333; font-size:12px; font-weight: 500;"><?php echo e(date('d M, Y', strtotime($pr->created_at))); ?></span>

        </div>

        <div class="content px-2">

            <a href="<?php echo e(route('regularisation-pending', ['id' => $pr->id])); ?>">
...
<!--[if BLOCK]><![endif]--><?php if($withdrawModal==true): ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="rejectBtn" wire:click="withdraw(<?php echo e($pr->id); ?>)">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<?php elseif($isHistory==1&&$defaultApply==0): ?>
<!--[if BLOCK]><![endif]--><?php if(count($historyRegularisations)>0): ?>
<!--[if BLOCK]><![endif]--><?php $__currentLoopData = $historyRegularisations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<!--[if BLOCK]><![endif]--><?php if(($hr->status=='pending'&&$hr->is_withdraw==1)||$hr->status=='approved'||$hr->status=='rejected'): ?>
<div class="accordion-heading rounded" onclick="toggleAccordion(this)" style="margin-top:10px;">
    ...
    <div class="accordion-title p-2 rounded">
        ...
        <div class="accordion-content">
            ...
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <!--[if BLOCK]><![endif]--><?php if($hr->status=='pending'&&$hr->is_withdraw==1): ?>
        ...
        <div class="accordion-content">
            <!--[if BLOCK]><![endif]--><?php if($hr->status=='approved'): ?>
            <span style="margin-top:0.625rem; font-size: 12px; font-weight: 400; color:green;text-transform:uppercase;">closed</span>
            <?php elseif($hr->status=='rejected'): ?>
            <span style="margin-top:0.625rem; font-size: 12px; font-weight: 400; color:#f66;text-transform:uppercase;"><?php echo e($hr->status); ?></span>
            <?php elseif($hr->status=='pending'&&$hr->is_withdraw==1): ?>
...
<div class="accordion-body m-0 p-0">
    ...
    <div class="content px-2">
        ...
        <span style="color: #778899; font-size: 12px; font-weight: 500;">Dates Applied:
            <?php echo e(date('d M Y', strtotime($firstEntry['date']))); ?> to
        </span>
        <?php elseif($numberOfEntries==1): ?>
        <span style="color: #778899; font-size: 12px; font-weight: 500;">Dates Applied:
            <?php echo e(date('d M Y', strtotime($firstEntry['date']))); ?></span>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </div>
    ...
    <div style="display:flex; flex-direction:row; justify-content:space-between;">
        ...
        <div class="content px-2">
            ...
            <span style="color: #333; font-size:12px; font-weight: 500;"><?php echo e(date('d M, Y', strtotime($hr->created_at))); ?></span>
            <?php elseif($hr->status=='rejected'): ?>
        ...
        <div class="content px-2">
            ...
            <a href="<?php echo e(route('regularisation-history', ['id' => $hr->id])); ?>">
...
</div><?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/regularisation.blade.php ENDPATH**/ ?>