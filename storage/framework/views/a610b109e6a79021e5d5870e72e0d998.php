            ...
            <div class="row m-0 mb-3">
                <div class="col-md-6 mb-3">
                    <div class="homeCard4 ps-4" style="height: 15em;">
                        ...
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <p class="fw-bold fs-3">Welcome, <?php echo e(ucwords(strtolower($employee_details->first_name))); ?> <?php echo e(ucwords(strtolower($employee_details->last_name))); ?></p>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                        ...
                        <div class="reviews">
                            <div class="homeCard1">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(($this->count) > 0): ?>
                                    ...
                                    ?>
                                    <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < min($count, 3); $i++): ?>
                                        <?php
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="d-flex flex-row">
                                <!--[if BLOCK]><![endif]--><?php if($count > 3): ?>
                                    <!--[if BLOCK]><![endif]--><?php for($i = 3; $i <= $count; $i++): ?>
                                ...
                                <div class="d-flex flex-row">
                                    <!--[if BLOCK]><![endif]--><?php for($i = 0; $i <= $countofregularisations; $i++): ?>
                        ...
                        <div class="homeCard6" style="padding:10px 15px;">
                            <div style="color: #677A8E;  font-weight:500; display:flex;justify-content:space-between;">
                                ...
                                <a href="/whoisinchart" style="font-size:16px; "><img src="/images/up-arrow.png" alt="" style="width:20px;height:27px;"></a>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($CountAbsentEmployees > 0): ?>            
                                            <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < min($CountAbsentEmployees, 4); $i++): ?>
                                            <!--[if BLOCK]><![endif]--><?php if(isset($AbsentEmployees[$i])): ?>
                                            <?php
                            ...
                            <!-- /second row -->
                                ...
                                <div class="who-is-in d-flex flex-column justify-content-start ">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < min($CountLateSwipes, 9); $i++): ?>
                                                <?php
                                                    $employee = $LateSwipes[$i];
                                                ?>
                                            
                                                <!--[if BLOCK]><![endif]--><?php if(isset($LateSwipes[$i])): ?>
                                                            <a href="/whoisinchart" style="text-decoration: none;">
                                ...
                                <div class="who-is-in d-flex flex-column justify-content-start">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < min($CountEarlySwipes, 9); $i++): ?>
                                            <!--[if BLOCK]><![endif]--><?php if(isset($EarlySwipes[$i])): ?>
                                            <?php
                                    ...
                                    <div class="team-Notify px-3">
                                        <p style="color: #778899; font-size: 11px; font-weight: 500;">
                                            ...
                                            <div class="team-leave d-flex flex-row  gap-3" >
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < min($teamCount, 4); $i++): ?>
                                                        <?php
...
<script>
    ...
    datasets: [
        {
            data: [
                <?php echo e(!empty($salaries) ? $salaries->calculateTotalAllowance() : 0); ?>,
        ...
        {
            data: [
                <?php echo e(!empty($salaries) && method_exists($salaries, 'calculateTotalDeductions') ? $salaries->calculateTotalDeductions() : 0); ?>,
                <?php echo e(!empty($salaries) && method_exists($salaries, 'calculateTotalAllowance') ? $salaries->calculateTotalAllowance() - $salaries->calculateTotalDeductions() : 0); ?>,
            ],
            backgroundColor: [
...
<?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/home.blade.php ENDPATH**/ ?>