            ...
            <div class="row m-0 mb-3">
                <div class="col-md-6">
                    <div class="ps-4" style="height: 15em; border-radius: 10px; background-color: #fff;">
                        ...
                        <h1 class="pt-4 greet-text text-secondary-500 pb-1.5x" style="font-size: 24px; font-family: montserrat;color:rgb(2, 17, 79); font-weight: 600;"><?php echo e($greetingText); ?></h1>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <p class="fw-bold fs-5" style="color:rgb(2, 17, 79);">Welcome, <?php echo e(ucwords(strtolower($loginEmployee->first_name))); ?> <?php echo e(ucwords(strtolower($loginEmployee->last_name))); ?> </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="" style="background-image: url(<?php echo e(asset('/images/morning_animated-ezgif.gif')); ?>); height: 15em;     background-repeat: no-repeat;
                ...
                <div class="col-7 p-0">
                    ...
                    <div>
                        <p style="color: #677A8E; font-size: 11px;margin-bottom:10px;">
                            <span style="font-weight: 500;"><?php echo e(date('d M', strtotime($entry->date))); ?>

                                <span style="font-size: 10px; font-weight: normal;"><?php echo e(date('l', strtotime($entry->date))); ?></span>
                            </span>
                            <br>
            ...
            <div>
                ...
                <div class="who-is-in d-flex flex-column justify-content-start ">
                    ...
                    <div class="team-leave d-flex flex-row  gap-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < min($CountLateSwipes, 5); $i++): ?> <?php $employee=$LateSwipes[$i]; ?> <!--[if BLOCK]><![endif]--><?php if(isset($LateSwipes[$i])): ?> <a href="/whoisinchart" style="text-decoration: none;">
                ...
                <div class="who-is-in d-flex flex-column justify-content-start">
                    ...
                    <div class="team-leave d-flex flex-row mr gap-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php for($i = 0; $i < min($CountEarlySwipes, 5); $i++): ?> <!--[if BLOCK]><![endif]--><?php if(isset($EarlySwipes[$i])): ?> <?php $employee=$EarlySwipes[$i]; $randomColorEarly='#' . str_pad(dechex(mt_rand(0xCCCCCC, 0xFFFFFF)), 6, '0' , STR_PAD_LEFT); ?> <a href="/whoisinchart" style="text-decoration: none;"></a>
                            <div class="circle" style="border: 2px solid <?php echo e(getRandomAbsentColor()); ?>;border-radius:50%;width: 35px;height: 35px;display: flex;align-items: center;justify-content: center;" data-toggle="tooltip" data-placement="top" title="<?php echo e(ucwords(strtolower($employee['first_name']))); ?> <?php echo e(ucwords(strtolower($employee['last_name']))); ?>">
                                <span class="initials">
                                    <?php echo e(strtoupper(substr(trim($employee['first_name']), 0, 1))); ?><?php echo e(strtoupper(substr(trim($employee['last_name']), 0,1))); ?>
...
<div class="modal-backdrop fade show blurred-backdrop"></div>
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<!--[if BLOCK]><![endif]--><?php if($showAllEarlyEmployees): ?>
<div class="modal" tabindex="-1" role="dialog" style="display: block;">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(2, 17, 79); height: 50px">
            ...
            <div class="modal-body" style="max-height:300px;overflow-y:auto">
                <div class="who-is-in d-flex flex-column justify-content-start ">
                    ...
                    <div class="team-leave d-flex flex-row gap-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php for($i = 0; $i <$CountEarlySwipes; $i++): ?> <!--[if BLOCK]><![endif]--><?php if(isset($EarlySwipes[$i])): ?> <?php $employee=$EarlySwipes[$i]; $randomColorEarly='#' . str_pad(dechex(mt_rand(0, 0xFFFFFF)), 6, '0' , STR_PAD_LEFT); ?> <a href="/whoisinchart" style="text-decoration: none;">
                            <div class="thisCircle" style="border: 2px solid <?php echo e(getRandomEarlyColor()); ?>;" data-toggle="tooltip" data-placement="top" title="<?php echo e(ucwords(strtolower($employee['first_name']))); ?> <?php echo e(ucwords(strtolower($employee['last_name']))); ?>">
                                <span class="initials">
                                    <?php echo e(strtoupper(substr(trim($employee['first_name']), 0, 1))); ?><?php echo e(strtoupper(substr(trim($employee['last_name']), 0,1))); ?>
...
<div class="modal-backdrop fade show blurred-backdrop"></div>
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<!--[if BLOCK]><![endif]--><?php if($showAllAbsentEmployees): ?>
<div class="modal" tabindex="-1" role="dialog" style="display: block;">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(2, 17, 79); height: 50px">
            ...
            <div class="modal-body" style="max-height:300px;overflow-y:auto">
                <div class="who-is-in d-flex flex-column justify-content-start ">
                    ...
                    <div class="team-leave d-flex flex-row gap-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php for($i = 0; $i <$CountAbsentEmployees; $i++): ?> <!--[if BLOCK]><![endif]--><?php if(isset($AbsentEmployees[$i])): ?> <?php $employee=$AbsentEmployees[$i]; $randomColorAbsent='#' . str_pad(dechex(mt_rand(0, 0xFFFFFF)), 6, '0' , STR_PAD_LEFT); ?> <a href="/whoisinchart" style="text-decoration: none;">
                            <div class="thisCircle" style="border: 2px solid <?php echo e(getRandomAbsentColor()); ?>;" data-toggle="tooltip" data-placement="top" title="<?php echo e(ucwords(strtolower($employee['first_name']))); ?> <?php echo e(ucwords(strtolower($employee['last_name']))); ?>">
                                <span class="initials">
                                    <?php echo e(strtoupper(substr(trim($employee['first_name']), 0, 1))); ?><?php echo e(strtoupper(substr(trim($employee['last_name']), 0,1))); ?>
...
<div class="modal-backdrop fade show blurred-backdrop"></div>
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<!--[if BLOCK]><![endif]--><?php if($showAllLateEmployees): ?>
<div class="modal" tabindex="-1" role="dialog" style="display: block;">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(2, 17, 79); height: 50px">
            ...
            <div class="modal-body" style="max-height:300px;overflow-y:auto">
                <div class="who-is-in d-flex flex-column justify-content-start ">
                    <p class="section-name">
                        Late Arrivals (<?php echo e($CountLateSwipes); ?>)
                    </p>
                    <div class="team-leave d-flex flex-row gap-3">


                        <!--[if BLOCK]><![endif]--><?php for($i = 0; $i <$CountLateSwipes; $i++): ?> <!--[if BLOCK]><![endif]--><?php if(isset($LateSwipes[$i])): ?> <?php $employee=$LateSwipes[$i]; $randomColorLate='#' . str_pad(dechex(mt_rand(0, 0xFFFFFF)), 6, '0' , STR_PAD_LEFT); ?> <a href="/whoisinchart" style="text-decoration: none;">
                            <div class="thisCircle" style="border: 2px solid <?php echo e(getRandomLateColor()); ?>;" data-toggle="tooltip" data-placement="top" title="<?php echo e(ucwords(strtolower($employee['first_name']))); ?> <?php echo e(ucwords(strtolower($employee['last_name']))); ?>">
                                <span class="initials">
                                    <?php echo e(strtoupper(substr(trim($employee['first_name']), 0, 1))); ?><?php echo e(strtoupper(substr(trim($employee['last_name']), 0,1))); ?>
