                ...
                <div class="heading-2" >
                    ...
                    <div class="field">
                                        ...
                                        <span style="color: #333; font-weight: 500;font-size:12px;">
                                            <?php echo e($employeeDetails->first_name); ?>&nbsp;&nbsp;<?php echo e($employeeDetails->last_name); ?>
              ...
              <div style="padding-top:5px;">
                <h5 style="color: #333; font-size: 12px; font-weight: 400; text-align:start;">
                           ...
                           <span style="color: #778899; font-weight: 500;">
                               <?php echo e(strtoupper($ManagerName->first_name)); ?>&nbsp;<?php echo e(strtoupper($ManagerName->last_name)); ?>
        ...
        <table style=" width: 50%;height:60%"> 
              <thead style="height:40%;background-color:white">
                ...
                <tbody class="regularisationEntries"style="height:50%;">
                        ...
                        <td style="padding: 8px;"><?php echo e(\Carbon\Carbon::parse($r1['date'])->format('d M, Y')); ?></td>
     ...
     <table style="width: 50%;height:60%">
        ...
        <tbody class="regularisationEntries"style="height:40%;">
                ...
                <td class="tooltip-container" style="max-width: 10px; border-right: 1px solid #dcdcdc;">
                            <span class="tooltip-text" style="display: inline-block; max-width: 100%; overflow: hidden; text-overflow: ellipsis;"data-tooltip="<?php echo e($r1['reason']); ?>"><?php echo e($r1['reason']); ?></span>
                </td>
        </tbody>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
    </table>
  </div>
</div><?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/review-pending-regularisation.blade.php ENDPATH**/ ?>