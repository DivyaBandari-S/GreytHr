                    ...
                    <div class="c" style="contain: content; margin-left:20px;overflow-y: auto; height: 300px;">
                        <!--[if BLOCK]><![endif]--><?php if($conversations): ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $conversation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <li id="conversation-<?php echo e($conversation->id); ?>" wire:key="<?php echo e($conversation->id); ?>"
                                    class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-700/70 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 <?php echo e($conversation->id == $selectedConversation?->emp_id ? 'bg-gray-100/70' : ''); ?>"
                                    ...
                                    <img style="border-radius: 50%; margin-left: auto; margin-right: auto; display: block; height: 40px; width: 40px; margin-top: 5px;"
                                        src="<?php echo e(asset('storage/' . $conversation->getReceiver()->image)); ?>"
                                        class="card-img-top" alt="...">
                                    <aside class="grid grid-cols-12 w-full">
                                        <?php echo e($conversation->id); ?>

                                        <a href="#"
                                            wire:click="redirectToEncryptedLink('<?php echo e($conversation->id); ?>')"
                                            ...
                                            <div class="flex justify-between w-full items-center">
                                                <div style="display:flex">
                                                    ...
                                                    <small class="text-gray-700"
                                                        style="color: #888888;margin-left: auto;"><?php echo e($conversation->messages?->last()?->created_at?->shortAbsoluteDiffForHumans()); ?></small>
                                                </div>
        ...
        <div class="chat">
            <div class="chat-header clearfix" style="border-radius:5px;border:2px solid silver">
                <img style="border-radius: 50%; margin-left: auto; margin-right: auto; display: block; height: 50px; width: 50px;margin-top:5px"
                    src="<?php echo e(asset('storage/' . $selectedConversation->getReceiver()->image)); ?>" class="card-img-top"
                    alt="...">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="name-box" style="background-color: #f0f8f7; padding: 10px; border-radius: 5px;">
                                <div style="color: #28a745;">
                                    ...
                                    <div class="text-muted"><?php echo e($selectedConversation->getReceiver()->emp_id); ?></div>
                                </div>
                            </div>
            ...
            <div class="chat-history" id="messageList">
                ...
                <!--[if BLOCK]><![endif]--><?php if($showDate || $message->created_at->greaterThan(now()->subDays(5))): ?>
                    <li class="date-header"><?php echo e($dateString); ?></li>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($attachment && !$body): ?>
                                <div class="container attachment-container" style="width:100%;height:60px">
                                    <!--[if BLOCK]><![endif]--><?php if(Str::startsWith($attachment->getMimeType(), 'image/')): ?>
                                        <img src="<?php echo e($attachment->temporaryUrl()); ?>" alt="Selected Image"
...
<?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/chat/chat-box.blade.php ENDPATH**/ ?>