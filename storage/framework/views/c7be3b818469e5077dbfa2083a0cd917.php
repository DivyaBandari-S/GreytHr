        ...
        <div class="col-md-6" style="padding: 10px 40px">
            <div class="form-group">
                <div>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($activeTab == 'register'): ?>
                    <div class="card" style="padding:10px">
                        <form>
                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['user_type'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($user_type == 'Job Seeker'): ?>
                            <div class="form-group">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['user_full_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['user_confirm_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['user_mobile_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            font-family: Montserrat;
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['user_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            font-family: Montserrat;
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($user_type == 'Vendor'): ?>
            ...
            font-family: Montserrat;
                            ...
                            <div>
                                <img style="height:90px;width:80px" src="<?php echo e($company_logo->temporaryUrl()); ?>" alt="Image Preview" style="max-width: 300px;">
                            </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <div class="form-group">
                                <label style="font-size:12px;font-family: Montserrat;" for="fullName">Full
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <button onclick="window.location.href = '<?php echo e(url('/login')); ?>'" class="google-login-btn" style="width: 165px; margin-left: 180px; font-size: 12px;height:30px">
                    ...
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <!--[if BLOCK]><![endif]--><?php if($activeTab == 'login'): ?>
                    ...
                    <div class="card" style="padding:10px">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['login_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="form-group" style="margin-bottom: 5px;">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['login_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/login-and-register-for-jobs.blade.php ENDPATH**/ ?>