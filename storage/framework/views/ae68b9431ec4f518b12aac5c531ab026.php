...
.side-container {
            ...
            <div class="heading mb-3">
                <div class="heading-2" >
                    ...
                    <div class="field">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($regularisationrequest->status=='approved'): ?>
                                        <span style="color: #778899; font-size: 12px; font-weight: 500;">
                                            Approved by
                                        </span>
                                    <?php elseif($regularisationrequest->status=='rejected'): ?>
                                        <span style="color: #778899; font-size: 12px; font-weight: 500;">
                                            Rejected by
                                        </span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <?php echo e(ucwords(strtolower($regularisationrequest->approved_by))); ?>
                     ...
                     <div>
                        <span style="color: #32CD32; font-size: 12px; font-weight: 500; text-transform:uppercase;">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($regularisationrequest->status=='rejected'): ?>
                                    <span style="margin-top:0.625rem; font-size: 12px; font-weight: 500; color:#f66;text-transform:uppercase;"><?php echo e($regularisationrequest->status); ?></span>
                                <?php elseif($regularisationrequest->status=='approved'): ?>
                                    <span style="margin-top:0.625rem; font-size: 12px; font-weight: 500; color:#32CD32;text-transform:uppercase;"><?php echo e($regularisationrequest->status); ?></span>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </span>
                   </div>
                </div>
             ...
             <div class="v-line"></div>
              ...
              <div style="padding-top:20px;margin-top:-15px;">
                <h5 style="color: #333; font-size: 12px; font-weight: 400; text-align:start;">
                          ...
                          <?php elseif($regularisationrequest->status=='rejected'): ?>
                          <span style="color: #778899; font-weight: 500;">
                               <?php echo e(ucwords(strtolower($regularisationrequest->rejected_by))); ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($regularisationrequest->status=='approved'): ?>
                           <span style="color: #778899; font-size: 11px; font-weight: 400;text-align:start;">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(\Carbon\Carbon::parse($regularisationrequest->approved_date)->isToday()): ?>
                                                                 Today
                                                    <?php elseif(\Carbon\Carbon::parse($regularisationrequest->approved_date)->isYesterday()): ?>
                                                                Yesterday
                                                    <?php else: ?>
                                                         <?php echo e(\Carbon\Carbon::parse($regularisationrequest->approved_date)->format('jS M, Y')); ?>


                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                    &nbsp;&nbsp;&nbsp;
                                                        <?php echo e(\Carbon\Carbon::parse($regularisationrequest->approved_date)->format('h:i A')); ?>
                        ...
                        <span style="color: #778899; font-size: 11px; font-weight: 400;text-align:start;">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(\Carbon\Carbon::parse($regularisationrequest->rejected_date)->isToday()): ?>
                                                                 Today
                                                    <?php elseif(\Carbon\Carbon::parse($regularisationrequest->rejected_date)->isYesterday()): ?>
                                                                Yesterday
                                                    <?php else: ?>
                                                         <?php echo e(\Carbon\Carbon::parse($regularisationrequest->rejected_date)->format('jS M, Y')); ?>


                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                    &nbsp;&nbsp;&nbsp;
                                                        <?php echo e(\Carbon\Carbon::parse($regularisationrequest->rejected_date)->format('h:i A')); ?>
                  ...
                  <h5 style="color: #333; font-size: 12px; font-weight: 400; text-align:start;">Submitted<br>
                          ...
                          <!--[if BLOCK]><![endif]--><?php if(\Carbon\Carbon::parse($regularisationrequest->created_at)->isToday()): ?>
                                          ...
                                          <?php elseif(\Carbon\Carbon::parse($regularisationrequest->created_at)->isYesterday()): ?>
                                                      Yesterday
                                          <?php else: ?>
                                               <?php echo e(\Carbon\Carbon::parse($regularisationrequest->created_at)->format('jS M, Y')); ?>
  ...
  <thead style="background-color: white;">
    ...
    <tbody>
        <tr>
            <td style="width: 30%; font-size: 12px;padding:8px;"><?php echo e(\Carbon\Carbon::parse($r1['date'])->format('d M, Y')); ?></td>
            <!--[if BLOCK]><![endif]--><?php if($regularisationrequest->status == 'rejected'): ?>
            <td style="width: 20%; text-transform: uppercase; color: #f66; font-size: 12px;padding:8px;"><?php echo e($regularisationrequest->status); ?></td>
            <?php elseif($regularisationrequest->status == 'approved'): ?>
            <td style="width: 20%; text-transform: uppercase; color: #32CD32; font-size: 12px;padding:8px;"><?php echo e($regularisationrequest->status); ?></td>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <!--[if BLOCK]><![endif]--><?php if(empty($regularisationrequest->approver_remarks)): ?>
            <td style="width: 50%; border-right: 1px solid #dcdcdc; font-size: 12px;padding:8px;">-</td>
            <?php else: ?>
            <td style="width: 50%; border-right: 1px solid #dcdcdc; font-size: 12px;padding:8px;"><?php echo e(ucfirst($regularisationrequest->approver_remarks)); ?></td>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </tr>
    </tbody>
     ...
     <table style="width: 50%;height:60%">
        ...
        <tbody class="regularisationEntries"style="height:40%;">
                ...
                <td style="width:20%;font-size:12px;padding: 8px;">
                       ...
                       <!--[if BLOCK]><![endif]--><?php if(empty($r1['from'])): ?>
                            10:00
                       <?php else: ?>
                            <?php echo e($r1['from']); ?>
                ...
                <td style="width:20%;font-size:12px;padding: 0;">
                       ...
                       <!--[if BLOCK]><![endif]--><?php if(empty($r1['to'])): ?>
                            19:00
                       <?php else: ?>
                            <?php echo e($r1['to']); ?>
                ...
                <td class="tooltip-container" style="width:30%; border-right: 1px solid #dcdcdc;padding: 8px;">
                            <span class="tooltip-text" style="font-size: 12px;" data-tooltip="<?php echo e($r1['reason']); ?>"><?php echo e(ucwords(strtolower($r1['reason']))); ?></span>
                </td>
        </tbody>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
    </table>
...
<?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/review-closed-regularisation.blade.php ENDPATH**/ ?>