...
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    <!--[if BLOCK]><![endif]--><?php if($showAbsentReportDialog==true): ?>
    <div class="modal-body" style="max-height:300px;overflow-y:auto">
        ...
        <table class="swipes-table mt-2 border" style="width: 100%;">
            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $employees1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH C:\xampp\htdocs\GreytHr\resources\views/livewire/absent-report.blade.php ENDPATH**/ ?>